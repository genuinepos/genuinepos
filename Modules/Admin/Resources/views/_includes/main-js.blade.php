    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $('#dirRtl').on('click', function() {
                ...
                $('html').attr('dir', 'rtl');
                $('#rtlStyle').attr('href', "{{ asset('modules/admin/css/rtl-style.css') }}");
            ...
            $('.color-palette').on('click', function() {
                ...
                $(this).addClass('active').siblings().removeClass('active');
                $('#primaryColor').attr('href', "{{ asset('modules/admin/css/') }}/" + styleSheet + '.css');
            ...
            if (selectedStyleSheet) {
                ...
                $('#primaryColor').attr('href', "{{ asset('modules/admin/css/') }}/" + selectedStyleSheet + '.css');
            }
