                ...
                <div class="row g-1">
                    <div class="col-md-3">
                        <div class="card mail-sidebar">
                            <div class="card-body">
                                <button class="btn btn-default rounded-pill px-4 btn-block mb-2" data-bs-toggle="modal" data-bs-target="#addCompose"><i class="fa-duotone fa-pen-fancy"></i> Compose</button>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    <form id="all_delete_form" action="{{ route('communication.sms.delete_all') }}" method="post">
                                        @csrf
        ...
        <div class="modal-dialog four-col-modal" role="document">
            <div class="modal-content" style="margin-left: 32%;width: 54%;">
                ...
                <div class="modal-body">
                    <form id="mail_send" action="{{ route('communication.sms.send') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="col-5">
                                <button type="button" class="btn btn-primary btn-sm mb-2 p-1" id="addMoreButton"><i class="fas fa-plus"></i> Add More Phone Numbers</button>
                            </div>
                            ...
                            <div class="col-7">
                                <select name="group_id[]" class="form-control select2" multiple="multiple">
                                    ...
                                    @foreach ($filtered_contact_numbers as $filteredContactNumber)
                                        <option value="{{ $filteredContactNumber->group->id }}">{{ $filteredContactNumber->group->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        child += '<input type="text" name="to[]" class="form-control add_input" data-name="To" id="phone_number" placeholder="Phone Number" />';
