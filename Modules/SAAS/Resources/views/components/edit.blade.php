                    ...
                    <form method="POST" action="{{ route('saas.coupons.update',$coupon->id) }}" id="couponstoreForm" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <button type="button" class="btn btn-sm btn-toggle maximum_purchase_class @if($coupon->is_maximum_usage==1) active @endif"  data-toggle="button" aria-pressed="true" autocomplete="off">
                                    <div class="handle"></div>
                                </button>
                                <input type="hidden" id="maximum_purchase_input" name="is_maximum_usage" value="{{$coupon->is_maximum_usage}}">
                            </div>
