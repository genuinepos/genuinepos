        ...
        <div class="row g-0 align-items-center">
            <div class="col-xxl-6 col-xl-5 col-4 d-flex align-items-center gap-20">
                <div class="main-logo d-lg-block d-none">
                    <div class="logo-big">
                        <a href="index.html">
                            <img src="{{ asset('modules/saas/images/logo-black.png') }}" alt="Logo">
                        </a>
                    </div>
                    <div class="logo-small">
                        <a href="index.html">
                            <img src="{{ asset('modules/saas/images/logo-small.png') }}" alt="Logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="header-right-btns d-flex justify-content-end align-items-center">
                                ...
                                <div class="header-btn-box">
                                    ...
                                    <ul class="notification-dropdown dropdown-menu" aria-labelledby="notificationDropdown">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('modules/saas/images/avatar-4.png') }}" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('modules/saas/images/avatar-5.png') }}" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('modules/saas/images/avatar-6.png') }}" alt="image">
                                                </div>
                                                <div class="notification-txt">
                    ...
                    <div class="header-btn-box">
                        <button class="profile-btn" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('modules/saas/images/admin.png') }}" alt="image">
                        </button>
            ...
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="sidebar-bg-btn-box">
                        ...
                        <button class="sidebar-bg-btn" data-img="{{ asset('modules/saas/images/nav-bg-1.jpg') }}"></button>
                        <button class="sidebar-bg-btn" data-img="{{ asset('modules/saas/images/nav-bg-2.jpg') }}"></button>
                        <button class="sidebar-bg-btn" data-img="{{ asset('modules/saas/images/nav-bg-3.jpg') }}"></button>
                        <button class="sidebar-bg-btn" data-img="{{ asset('modules/saas/images/nav-bg-4.jpg') }}"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="main-content-bg-btn-box">
                        ...
                        <button class="main-content-bg-btn" data-img="{{ asset('modules/saas/images/main-bg-1.jpg') }}"></button>
                        <button class="main-content-bg-btn" data-img="{{ asset('modules/saas/images/main-bg-2.jpg') }}"></button>
                        <button class="main-content-bg-btn" data-img="{{ asset('modules/saas/images/main-bg-3.jpg') }}"></button>
                        <button class="main-content-bg-btn" data-img="{{ asset('modules/saas/images/main-bg-4.jpg') }}"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
