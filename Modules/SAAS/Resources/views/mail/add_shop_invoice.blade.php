                ...
                <tr>
                    <td>
                        <div class="mail-header">
                            <div class="logo">
                                <img style="height: height; width:auto;" src="{{ \Modules\SAAS\Utils\UrlGenerator::generateFullUrlFromDomain(config('app.domain')) }}/modules/saas/images/logo_black.png" alt="System Logo" class="logo__img">
                            </div>
                    ...
                    <td>
                        <div class="mail-body">
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="5" style="margin: 10px 0; padding: 10px;">
                                ...
                                <!-- Table data -->
                                <tr>
                                    <td>{{ $increasedShopCount }}</td>
                                    <td>{{ \App\Utils\Converter::format_in_bdt($pricePerShop) }}</td>
                                    <td>{{ $pricePeriod }}</td>
