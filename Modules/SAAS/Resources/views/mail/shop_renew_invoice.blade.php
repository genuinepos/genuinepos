                ...
                <tr>
                    <td>
                        <div class="mail-header">
                            <div class="logo">
                                <img style="height: height; width:auto;" src="{{ url('/') }}/assets/logo/logo.png" alt="System Logo" class="logo__img">
                            </div>
                    ...
                    <td>
                        <div class="mail-body">
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="5" style="margin: 10px 0; padding: 10px;">
                                ...
                                @if (isset($data['branch_names']))
                                    @foreach ($data['branch_names'] as $index => $branchName)
                                        <tr>
                                            <td>{{ $branchName }}</td>
                                            <td>{{ \App\Utils\Converter::format_in_bdt($data['shop_prices'][$index]) }}</td>
                                            <td>{{ $data['shop_price_periods'][$index] }}</td>
                                            <td>{{ $data['shop_price_periods'][$index] != 'lifetime' ? $data['shop_price_period_counts'][$index] : 'Lifetime' }}</td>
                                            <td>{{ \App\Utils\Converter::format_in_bdt($data['shop_subtotals'][$index]) }}</td>
                                        </tr>
                                    @endforeach
                                @endif
                                ...
                                <tr>
                                    ...
                                    <th>: {{ $planPriceCurrency }} {{ \App\Utils\Converter::format_in_bdt($data['net_total']) }}</th>
                                </tr>
