                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-check my-3">
                                    <input type="checkbox" class="permissions form-check-input" id="super_select_all">
                            ...
                            <section class="permissions">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        ...
                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_index" id="tenants_index" class="customers select_all">
                                            <label for="tenants_index"> {{ __('Customer List') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_show" id="tenants_show" class="customers select_all">
                                            <label for="tenants_show"> {{ __('Customer View') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_create" id="tenants_create" class="customers select_all">
                                            <label for="tenants_create">{{ __('Customer Add') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_upgrade_plan" id="tenants_upgrade_plan" class="customers select_all">
                                            <label for="tenants_destroy">{{ __('Customer Upgrade Plan') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_update_payment_status" id="tenants_update_payment_status" class="customers select_all">
                                            <label for="tenants_destroy">{{ __('Customer Update Payment Status') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_update_expire_date" id="tenants_update_expire_date" class="customers select_all">
                                            <label for="tenants_destroy">{{ __('Customer Update Expire Date') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="tenants_destroy" id="tenants_destroy" class="customers select_all">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        ...
                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="users_index" id="users_index" class="users select_all">
                                            <label for="users_index">{{ __('User List') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="users_create" id="users_create" class="users select_all">
                                            <label for="users_create"> {{ __('User Add') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="users_show" id="users_show" class="users select_all">
                                            <label for="users_show">{{ __('User View') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="users_update" id="users_update" class="users select_all">
                                            <label for="users_update"> {{ __('User Edit') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="users_destroy" id="users_destroy" class="users select_all">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        ...
                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="roles_index" id="roles_index" class="roles select_all">
                                            <label for="roles_index">{{ __('Role List') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="roles_create" id="roles_create" class="roles select_all">
                                            <label for="roles_create"> {{ __('Role Add') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="roles_update" id="roles_update" class="roles select_all">
                                            <label for="roles_update">{{ __('Role Edit') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="roles_destroy" id="roles_destroy" class="roles select_all">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        ...
                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="plans_index" id="plans_index" class="plans select_all">
                                            <label for="plans_index">{{ __('Plan List') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="plans_create" id="plans_create" class="plans select_all">
                                            <label for="plans_create"> {{ __('Plan Add') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="plans_update" id="plans_update" class="plans select_all">
                                            <label for="plans_update">{{ __('Plan Edit') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="plans_destroy" id="plans_destroy" class="plans select_all">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        ...
                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="coupons_index" id="coupons_index" class="coupons select_all">
                                            <label for="coupons_index">{{ __('Coupon List') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="coupons_create" id="coupons_create" class="coupons select_all">
                                            <label for="coupons_create"> {{ __('Coupon Add') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="coupons_update" id="coupons_update" class="coupons select_all">
                                            <label for="coupons_update">{{ __('Coupon Edit') }}</label>
                                        </p>

                                        <p class="checkbox_input_wrap mt-1">
                                            <input type="checkbox" name="coupons_destroy" id="coupons_destroy" class="coupons select_all">
