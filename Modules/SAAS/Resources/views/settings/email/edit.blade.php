        ...
        <div class="col-12">
            <div class="panel">
                <div class="panel-header">
                    <h5>{{ __('Update Email Settings') }}</h5>
                    <div class="btn-box">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('saas.email-settings.update',$settings->id) }}" id="couponstoreForm">
                        @csrf
                        {{method_field('PATCH')}}
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input type="number" name="mail_port" value="{{$settings->mail_port}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Enter Mail Port') }}" required>
                            </div>

                             <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="percent" class="form-label"><strong>{{ __('Mail Username') }}</strong><span class="text-danger">*</span></label>
                                <input type="text" name="mail_username" value="{{$settings->mail_username}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Enter Mail Username') }}" required>
                            </div>

                             <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="percent" class="form-label"><strong>{{ __('Mail Password') }}</strong><span class="text-danger">*</span></label>
                                <input type="text" name="mail_password" value="{{$settings->mail_password}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Enter Mail Password') }}" required>
                             </div>

                             <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="percent" class="form-label"><strong>{{ __('Mail Encryption') }}</strong><span class="text-danger">*</span></label>
                                <input type="text" name="mail_encryption" value="{{$settings->mail_encryption}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Enter Mail Encryption') }}" required>
                             </div>

                             <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="percent" class="form-label"><strong>{{ __('Mail From Address') }}</strong><span class="text-danger">*</span></label>
                                <input type="text" name="mail_from_address" value="{{$settings->mail_from_address}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Mail From Address') }}" required>
                             </div>

                              <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="percent" class="form-label"><strong>{{ __('Mail From Name') }}</strong><span class="text-danger">*</span></label>
                                <input type="text" name="mail_from_name" value="{{$settings->mail_from_name}}" class="form-control" id="percent" autocomplete="off" placeholder="{{ __('Mail From Name') }}" required>
                             </div>

                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="phone" class="form-label"><strong>{{ __('Active') }}</strong></label>
                                <button type="button" class="btn btn-sm btn-toggle minimum_purchase_class @if($settings->mail_active==1) active @endif" autocomplete="off" data-toggle="button" aria-pressed="true" autocomplete="off">
                                    <div class="handle"></div>
                                </button>
                                <input type="hidden" id="minimum_purchase_input" name="mail_active" value="{{$settings->mail_active}}">
                             </div>
