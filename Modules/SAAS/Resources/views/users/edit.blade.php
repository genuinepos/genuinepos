<x-saas::admin-layout title="Edit User">
    <div class="row">
        <div class="col-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('saas.users.update', $user->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="name" class="form-label"><strong>{{ __('Name') }}</strong> <span class="text-danger">*</span></label>
                                <input value="{{ $user->name }}" type="text" name="name" class="form-control" id="name" placeholder="{{ __('Enter fullname') }}" required>
                            </div>

                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="email" class="form-label"><strong>{{ __('Email') }}</strong> <span class="text-danger">*</span></label>
                                <input value="{{ $user->email }}" type="email" name="email" class="form-control" id="email" placeholder="{{ __('Enter email-address') }}" required>
                            </div>

                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="password" class="form-label"><strong>{{ __('Password') }}</strong></label>
                                <input type="password" name="password" class="form-control" id="password" placeholder="{{ __('Enter password') }}">
                            </div>
                        </div>

                        <div class="row mt-2">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label for="phone" class="form-label"><strong>{{ __('Phone Number') }}</strong> <span class="text-danger">*</span></label>
                                <input value="{{ $user->phone }}" type="text" name="phone" class="form-control" placeholder="{{ __('Enter phone number') }}" id="phone">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input value="{{ $user->address }}" type="text" name="address" class="form-control" placeholder="{{ __('Enter address') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="mt-3 text-end">
                                <input type="submit" class="btn btn-sm btn-primary" value="{{ __('Save Changes') }}" />
                            </div>
                        </div>
                    </form>
                </div>
