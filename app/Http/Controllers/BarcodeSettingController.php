...
class BarcodeSettingController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $barcodeSettings = DB::table('barcode_settings')->orderBy('id', 'DESC')->get(['id', 'name', 'description', 'is_default']);
    ...
    public function store(Request $request)
    {
        ...
        BarcodeSetting::insert([
            ...
            'paper_width' => $request->sticker_height,
        ...
        return response()->json('Barcode sticker setting created Successfully.');
    }
