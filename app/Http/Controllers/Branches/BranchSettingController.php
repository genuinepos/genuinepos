...
class BranchSettingController extends Controller
{
    ...
    public function serviceSettings($id, Request $request)
    {
        $settings = [
            ...
            'service_settings__device_label' => $request->device_label,
            'service_settings__device_model_label' => $request->device_model_label,
            'service_settings__serial_number_label' => $request->serial_number_label,
