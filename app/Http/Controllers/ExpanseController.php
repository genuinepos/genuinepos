    ...
    public function delete(Request $request, $expanseId)
    {
        ...
        if (!is_null($deleteExpanse)) {
            if ($deleteExpanse->paid > 0) {
                return response()->json(['errorMsg' => 'You can not delete this expense, already some or more amount is paid on this expanse.']);
            }
        ...
        foreach ($deleteExpanse->expense_payments as $payment) {
