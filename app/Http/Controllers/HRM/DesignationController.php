...
class DesignationController extends Controller
{
    ...
    {
        abort_if(!auth()->user()->can('designations_index') || config('generalSettings')['subscription']->features['hrm'] == BooleanType::False->value, 403);
    ...
    {
        abort_if(!auth()->user()->can('designations_create') || config('generalSettings')['subscription']->features['hrm'] == BooleanType::False->value, 403);
    ...
    {
        abort_if(!auth()->user()->can('designations_edit') || config('generalSettings')['subscription']->features['hrm'] == BooleanType::False->value, 403);
