...
class PayrollPaymentController extends Controller
{
    ...
    {
        abort_if(!auth()->user()->can('payroll_payments_create') || config('generalSettings')['subscription']->features['hrm'] == BooleanType::False->value, 403);
    ...
    {
        abort_if(!auth()->user()->can('payroll_payments_edit') || config('generalSettings')['subscription']->features['hrm'] == BooleanType::False->value, 403);
