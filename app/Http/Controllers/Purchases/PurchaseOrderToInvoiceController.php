...
class PurchaseOrderToInvoiceController extends Controller
{
    ...
    public function create(CodeGenerationServiceInterface $codeGenerator, $id = null)
    {
        $order = null;
        $invoiceId = null;
        if (isset($id)) {
            ...
            $invoiceId = $codeGenerator->generateMonthAndTypeWise(table: 'purchases', column: 'invoice_id', typeColName: 'purchase_status', typeValue: PurchaseStatus::Purchase->value, prefix: $invoicePrefix, splitter: '-', suffixSeparator: '-', branchId: auth()->user()->branch_id);
        }
