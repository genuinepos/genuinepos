...
use App\Services\Purchases\Reports\PurchaseReturnProductReportService;
use App\Http\Requests\Purchases\Reports\PurchaseReturnProductReportIndexRequest;
use App\Http\Requests\Purchases\Reports\PurchaseReturnProductReportPrintRequest;

class PurchaseReturnProductReportController extends Controller
{
    public function __construct(
        private PurchaseReturnProductReportService $purchaseReturnProductReportService,
    ...
    public function index(PurchaseReturnProductReportIndexRequest $request)
    {
        if ($request->ajax()) {
            ...
            return $this->purchaseReturnProductReportService->purchaseReturnProductReportTable(request: $request);
        }
    ...
    public function print(PurchaseReturnProductReportPrintRequest $request)
    {
        $ownOrParentBranch = '';
        if (auth()->user()?->branch) {
        ...
        $purchaseReturnProducts = $this->purchaseReturnProductReportService->query(request: $request)->get();
