...
class AccountLedgerService
{
    public function voucherType($voucher_type_id)
    {
        $data = [
            ...
            5 => ['name' => 'Expenses', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'expense_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
            ...
            8 => ['name' => 'Receipt', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'receipt_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
            9 => ['name' => 'Payment', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'payment_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
            12 => ['name' => 'Contra', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'contra_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
            13 => ['name' => 'Journal', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'journal_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
            15 => ['name' => 'Incomes', 'id' => 'accounting_voucher_description_id', 'voucher_no' => 'income_voucher', 'details_id' => 'accounting_voucher_id', 'link' => 'accounting.vouchers.show'],
