...
class DutiesAndTaxesAccountService
{
    public function dutiesAndTaxesAccountListTable($request)
    {
        // echo $request->all();
        ...
        return DataTables::of($accounts)
            ...
            ->addColumn('action', function ($row) {
                ...
                $html .= '<a id="editAccount" class="dropdown-item" href="' . route('accounts.edit', [$row->id, AccountCreateAndEditType::DutiesAndTaxes->value]) . '" > ' . __('Edit') . '</a>';
