...
class DayBookParticularService
{
    ...
    public function salesDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<td style="line-height:1.2 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->sale?->order_discount_amount) . '</td>';
            $voucherDetails .= '</tr>';
            ...
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->sale?->total_invoice_amount) . '</td>';
            $voucherDetails .= '</tr>';
        ...
        return '<p>' . $daybookReferenceBranch . '</p><p class="m-0 p-0"><strong><a href="' . route('accounts.ledger.index', [$showingAccountId]) . '" target="_blank">' . $showingAccount . '</a></strong></p>' . $voucherDetails . $inventoryDetails . $note;
    }
    ...
    public function purchaseReturnDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Return Tax') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->purchaseReturn?->return_tax_amount) . '</td>';
            $voucherDetails .= '</tr>';
    ...
    public function accountingVoucherDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<p>' . $daybookReferenceBranch . '</p><p><strong><a href="' . route('accounts.ledger.index', [($daybook?->account ? $daybook?->account?->id : 'null')]) . '" target="_blank">' . $daybook?->account?->name . '</a></strong></p>' . ($transactionDetails ? '<p class="p-0 m-0">' . $transactionDetails . '</p>' : '');
        }
    ...
    public function stockAdjustmentDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->stockAdjustment?->stockAdjustment) . '</td>';
            $voucherDetails .= '</tr>';
    ...
    public function payrollDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Employee') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $daybook?->payroll?->user?->prefix . ' ' . $daybook?->payroll?->user?->name . $daybook?->payroll?->user?->last_name . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Month') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $daybook?->payroll?->month . '/' . $daybook?->payroll?->year . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Amount') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->total_amount) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Allowance') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1.2 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->total_allowance) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Deduction') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1.2 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->total_deduction) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Gross Amount') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->gross_amount) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Paid') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->paid) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Due') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->payroll?->due) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '</table>';
        }

        return '<p>' . $daybookReferenceBranch . '</p><p class="m-0 p-0"><strong><a href="' . route('accounts.ledger.index', [$showingAccountId]) . '" target="_blank">' . $showingAccount . '</a></strong></p>' . $voucherDetails;
    }
    ...
    public function stockIssueDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Item') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->stockIssue?->total_item) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->stockIssue?->total_qty) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Net Total Amount') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->stockIssue?->net_total_amount) . '</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
        ...
        if ($request->inventory_list == BooleanType::True->value) {
            ...
            foreach ($daybook->stockIssue->stockIssuedProducts as $issuedProduct) {
                ...
                $inventoryDetails .= '<tr>';
                $inventoryDetails .= '<td style="line-height:1 !important;" class="w-50">- ' . $issuedProduct?->product?->name . $variantName . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">' . \App\Utils\Converter::format_in_bdt($issuedProduct->quantity) . '/' . $issuedProduct?->unit->code_name . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">(' . \App\Utils\Converter::format_in_bdt($issuedProduct->quantity) . 'X' . $issuedProduct->unit_cost_inc_tax . ')</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">=' . \App\Utils\Converter::format_in_bdt($issuedProduct->subtotal) . '</td>';
                $inventoryDetails .= '</tr>';
            }
            $inventoryDetails .= '</table>';
        }
    ...
    public function productionDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Output Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->production?->total_output_quantity) . '/' . $daybook?->production?->unit?->code_name . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Wasted Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->production?->total_wasted_quantity) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Final Output Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->production?->total_final_output_quantity) . '/' . $daybook?->production?->unit?->code_name . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Additional Production Cost') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->production?->additional_production_cost) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Net Cost') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->production?->net_cost) . '</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
        ...
        if ($request->inventory_list == BooleanType::True->value) {
            ...
            $inventoryDetails .= '<table class="w-100 td_child_table">';
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:0.5 !important;"><strong>(' . __('Ingredients') . ')' . ' :</strong></td>';
            $voucherDetails .= '</tr>';
            foreach ($daybook->production->ingredients as $ingredient) {
                ...
                $inventoryDetails .= '<tr>';
                $inventoryDetails .= '<td style="line-height:1 !important;" class="w-50">- ' . $ingredient?->product?->name . $variantName . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">' . \App\Utils\Converter::format_in_bdt($ingredient->final_qty) . '/' . $ingredient?->unit?->code_name . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">(' . \App\Utils\Converter::format_in_bdt($ingredient->unit_tax_percent) . '=' . \App\Utils\Converter::format_in_bdt($ingredient->unit_tax_amount) . ')</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">(' . \App\Utils\Converter::format_in_bdt($ingredient->final_qty) . 'X' . \App\Utils\Converter::format_in_bdt($ingredient->unit_cost_inc_tax) . ')</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">=' . \App\Utils\Converter::format_in_bdt($ingredient->subtotal) . '</td>';
                $inventoryDetails .= '</tr>';
            }
            $inventoryDetails .= '</table>';
        }
    ...
    public function transferStockDetails(object $request, object $daybook): string
    {
        ...
        if ($request->voucher_details == BooleanType::True->value) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Send From') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $senderBranch . '</td>';
            $voucherDetails .= '</tr>';

            if (isset($senderWarehouse)) {
                $voucherDetails .= '<tr>';
                $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('At') . '</strong></td>';
                $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $senderWarehouse . '</td>';
                $voucherDetails .= '</tr>';
            }

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Receive From') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $receiverBranch . '</td>';
            $voucherDetails .= '</tr>';

            if (isset($receiverWarehouse)) {
                $voucherDetails .= '<tr>';
                $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('At') . '</strong></td>';
                $voucherDetails .= '<td style="line-height:1 !important;"> : ' . $receiverWarehouse . '</td>';
                $voucherDetails .= '</tr>';
            }

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Receive Status') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . TransferStockReceiveStatus::tryFrom($daybook?->transferStock?->receive_status)->name . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Send Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->transferStock?->total_send_qty) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Stock Value') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->transferStock?->total_stock_value) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Received Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->transferStock?->total_received_qty) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Total Received Qty') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->transferStock?->total_pending_qty) . '</td>';
            $voucherDetails .= '</tr>';

            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:1 !important;" class="w-60"><strong>' . __('Received Stock Value') . '</strong></td>';
            $voucherDetails .= '<td style="line-height:1 !important;"> : ' . \App\Utils\Converter::format_in_bdt($daybook?->transferStock?->received_stock_value) . '</td>';
            $voucherDetails .= '</tr>';
        ...
        if ($request->inventory_list == BooleanType::True->value) {
            ...
            foreach ($daybook->transferStock->transferStockProducts as $transferredProduct) {
                ...
                $inventoryDetails .= '<tr>';
                $inventoryDetails .= '<td style="line-height:1 !important;" class="w-50">- ' . $transferredProduct?->product?->name . $variantName . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">' . \App\Utils\Converter::format_in_bdt($transferredProduct->send_qty) . '/' . $transferredProduct?->unit->code_name . '</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">(' . \App\Utils\Converter::format_in_bdt($transferredProduct->send_qty) . 'X' . $transferredProduct->unit_cost_inc_tax . ')</td>';

                $inventoryDetails .= '<td style="line-height:1 !important;">=' . \App\Utils\Converter::format_in_bdt($transferredProduct->subtotal) . '</td>';
                $inventoryDetails .= '</tr>';
            }
            $inventoryDetails .= '</table>';
        }
