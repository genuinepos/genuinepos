...
class CustomerGroupService
{
    public function customerGroupsTable($request)
    {
        ...
        return DataTables::of($customerGroups)
            ...
            ->editColumn('price_calculation_type', function ($row) use ($generalSettings) {

                return CustomerGroupPriceCalculationType::tryFrom($row->price_calculation_type)->name;
            })
            ->editColumn('calculation_percentage', function ($row) use ($generalSettings) {
    ...
    public function addCustomerGroup(object $request): void
    {
        ...
        } else if ($request->price_calculation_type == CustomerGroupPriceCalculationType::SellingPriceGroup->value) {
