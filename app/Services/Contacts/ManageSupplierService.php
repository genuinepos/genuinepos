...
{
    function supplierListTable($request)
    {
        ...
        return DataTables::of($suppliers)
            ...
            ->editColumn('total_purchase', function ($row) use ($request) {
            ...
            ->editColumn('total_received', function ($row) use ($request) {
            ...
            ->editColumn('current_balance', function ($row) use ($request) {
