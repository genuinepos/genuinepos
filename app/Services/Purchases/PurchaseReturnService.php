...
class PurchaseReturnService
{
    ...
    public function addPurchaseReturn(object $request, object $codeGenerator, string $voucherPrefix = null): object
    {
        ...
        $addPurchaseReturn->net_total_amount = $request->net_total_amount ? $request->net_total_amount : 0;
        ...
        $addPurchaseReturn->due = $request->total_return_amount ? $request->total_return_amount : 0;
