...
class PurchaseService
{
    ...
    public function addPurchase(object $request, object $codeGenerator, string $invoicePrefix): ?object
    {
        ...
        $addPurchase->total_item = $request->total_item ? $request->total_item : 0;
        $addPurchase->total_qty = $request->total_qty ? $request->total_qty : 0;
        ...
        $addPurchase->total_purchase_amount = $request->total_purchase_amount ? $request->total_purchase_amount : 0;
        $addPurchase->paid = $request->paying_amount ? $request->paying_amount : 0;
        $addPurchase->due = $request->total_purchase_amount ? $request->total_purchase_amount : 0;
    ...
    public function updatePurchase(object $request, object $updatePurchase): object
    {
        ...
        $updatePurchase->total_item = $request->total_item ? $request->total_item : 0;
        $updatePurchase->total_qty = $request->total_qty ? $request->total_qty : 0;
        $updatePurchase->net_total_amount = $request->net_total_amount ? $request->net_total_amount : 0;
        $updatePurchase->order_discount = $request->order_discount ? $request->order_discount : 0;
        $updatePurchase->order_discount_type = $request->order_discount_type;
        $updatePurchase->order_discount_amount = $request->order_discount_amount ? $request->order_discount_amount : 0;
        $updatePurchase->purchase_tax_ac_id = $request->purchase_tax_ac_id;
        $updatePurchase->purchase_tax_percent = $request->purchase_tax_percent ? $request->purchase_tax_percent : 0;
        $updatePurchase->purchase_tax_amount = $request->purchase_tax_amount ? $request->purchase_tax_amount : 0;
        $updatePurchase->total_purchase_amount = $request->total_purchase_amount ? $request->total_purchase_amount : 0;
