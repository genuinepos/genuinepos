...
class SoldProductReportService
{
    public function soldProductReportTable(object $request): object
    {
        $generalSettings = config('generalSettings');

        $saleProducts = $this->query(request: $request);
        ...
        return DataTables::of($saleProducts)
            ...
            ->rawColumns(['product', 'date', 'branch', 'stock_location', 'quantity', 'invoice_id', 'unit_price_exc_tax', 'unit_discount_amount', 'unit_tax_amount', 'unit_price_inc_tax', 'subtotal'])
            ->make(true);
    }
