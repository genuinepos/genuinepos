...
class BranchSettingService
{
    ...
    public function addBranchSettings(int $branchId, ?int $parentBranchId = null, int $defaultInvoiceLayoutId, object $branchService, object $request): void
    {
        ...
        $generalSettings = [
            ...
            ['key' => 'service_settings__customer_field_1', 'value' => null, 'branch_id' => !isset($parentBranchId) ? $branchId : null],
            ['key' => 'service_settings__customer_field_2', 'value' => null, 'branch_id' => !isset($parentBranchId) ? $branchId : null],
            ['key' => 'service_settings__customer_field_3', 'value' => null, 'branch_id' => !isset($parentBranchId) ? $branchId : null],
            ['key' => 'service_settings__customer_field_4', 'value' => null, 'branch_id' => !isset($parentBranchId) ? $branchId : null],
            ['key' => 'service_settings__customer_field_5', 'value' => null, 'branch_id' => !isset($parentBranchId) ? $branchId : null],
