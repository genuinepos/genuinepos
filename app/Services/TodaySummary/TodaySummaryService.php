...
namespace App\Services\TodaySummary;
...
{
    public function prepare(object $request): array
    {
        ...
        $profitLoss = (new \App\Services\Accounts\Reports\ProfitLossService())->profitLossAmounts(branchId: $branchId, fromDate: date('Y-m-d'), toDate: date('Y-m-d'), getParentBranchData: false);
