...
class TransferStockControllerMethodContainersService implements TransferStockControllerMethodContainersInterface
{
    ...
    public function createMethodContainer(): ?array
    {
        ...
        $data['branches'] = $this->branchService->branches(with: ['parentBranch', 'branchCurrency:id,country,currency,code,symbol,currency_rate,type'])->orderByRaw('COALESCE(branches.parent_branch_id, branches.id), branches.id')->get();
