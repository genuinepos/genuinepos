...
{
    public function transferStockTable(object $request): object
    {
    ...
    public function addTransferStock(object $request, object $codeGenerator, $voucherPrefix): object
    {
        $voucherNo = $codeGenerator->generateMonthWise(table: 'transfer_stocks', column: 'voucher_no', prefix: $voucherPrefix, splitter: '-', suffixSeparator: '-', branchId: auth()->user()->branch_id);
    ...
    public function updateTransferStock(object $request, int $id): object
    {
