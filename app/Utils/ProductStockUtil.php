...
class ProductStockUtil
{
    ...
    public function adjustMainBranchStock($product_id, $variant_id)
    {
        ...
        $singleProduct->mb_total_sale = $productSale->sum('total_sale');
        $singleProduct->save();
        ...
        if ($variant_id) {
            ...
            $variantProduct->mb_total_sale = $productSale->sum('total_sale');
            $variantProduct->save();
        }
    }
    ...
    public function adjustBranchStock($product_id, $variant_id, $branch_id)
    {
        ...
        $productBranch->total_sale = $productSale;
        $productBranch->save();
        ...
        if ($variant_id) {
            ...
            $productBranchVariant->total_sale = $productSale;
