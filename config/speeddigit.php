...
return [
    ...
    'facebook' => env('FACEBOOK_LINK', 'https://www.facebook.com/gposofficial'),
    'twitter' => env('TWITTER_LINK', 'https://x.com/GposSystem'),
    'instagram' => env('INSTAGRAM_LINK', 'https://www.instagram.com/gpossystem/'),
    'youtube' => env('YOUTUBE_LINK', 'https://www.youtube.com/@GPOSSystem'),
    'linkedin' => env('LINKEDIN_LINK', 'https://www.linkedin.com/company/gpos-system'),
    'tiktok' => env('TIKTOK_LINK', 'https://www.tiktok.com/@gpossystem'),
