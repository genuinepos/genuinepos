...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_branch_variants', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('product_branch_id')->nullable()->index('product_branch_variants_product_branch_id_foreign');
            $table->unsignedBigInteger('product_id')->nullable()->index('product_branch_variants_product_id_foreign');
            $table->unsignedBigInteger('product_variant_id')->nullable()->index('product_branch_variants_product_variant_id_foreign');
