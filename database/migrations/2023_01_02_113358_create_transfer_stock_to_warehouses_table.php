...
class CreateTransferStockToWarehousesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transfer_stock_to_warehouses', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('branch_id')->nullable()->index('transfer_stock_to_warehouses_branch_id_foreign')->comment('form_branch');
            $table->unsignedBigInteger('warehouse_id')->index('transfer_stock_to_warehouses_warehouse_id_foreign')->comment('to_warehouse');
