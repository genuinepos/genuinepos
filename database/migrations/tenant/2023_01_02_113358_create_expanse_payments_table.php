...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('expanse_payments', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('expanse_id')->index('expanse_payments_expanse_id_foreign');
            $table->unsignedBigInteger('account_id')->nullable()->index('expanse_payments_account_id_foreign');
            ...
            $table->timestamps();
            $table->unsignedBigInteger('payment_method_id')->nullable()->index('expanse_payments_payment_method_id_foreign');
        });
    }
