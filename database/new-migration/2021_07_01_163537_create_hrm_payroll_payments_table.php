...
class CreateHrmPayrollPaymentsTable extends Migration {
	...
	public function up()
	{
		Schema::create('hrm_payroll_payments', function(Blueprint $table)
		{
			...
			$table->bigInteger('payroll_id')->unsigned()->nullable()->index('hrm_payroll_payments_payroll_id_foreign');
			$table->bigInteger('account_id')->unsigned()->nullable()->index('hrm_payroll_payments_account_id_foreign');
			...
			$table->bigInteger('admin_id')->unsigned()->nullable()->index('hrm_payroll_payments_admin_id_foreign');
			$table->timestamps();
		});
	}
	...
	{
		Schema::drop('hrm_payroll_payments');
	}
