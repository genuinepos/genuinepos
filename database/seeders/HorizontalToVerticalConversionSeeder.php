...
class HorizontalToVerticalConversionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $general_settings['business'] = '{"shop_name":"GenuinePos","address":"Uttara, Sector - 4, Road No - 7, House No - 17, Dhaka, Bangladesh.","phone":"01719244933, 1722789897","email":"gollachuttelecare@gmail.com","start_date":null,"default_profit":0,"currency":"TK.","currency_placement":null,"date_format":"d-m-Y","stock_accounting_method":"2","time_format":"12","business_logo":"6352b2cbad890-.png","timezone":"Asia\/Dhaka"}';
