...
class PosShortMenusSeeder extends Seeder
{
    ...
    public function run()
    {
        $pos_short_menus = array(
            ...
            array('id' => '26','url' => 'expanses.create','name' => 'Add Expense','icon' => 'fas fa-plus-square','created_at' => '2021-08-21 15:41:00','updated_at' => '2021-08-21 15:41:00'),
            array('id' => '27','url' => 'expanses.index','name' => 'Expense List','icon' => 'far fa-list-alt','created_at' => '2021-08-21 15:41:00','updated_at' => '2021-08-21 15:41:00'),
            array('id' => '28','url' => 'expanses.categories.index','name' => 'Expense Categories Categories','icon' => 'fas fa-cubes','created_at' => '2021-08-21 15:41:00','updated_at' => '2021-08-21 15:41:00'),
