...
class RolePermissionSeeder extends Seeder
{
    ...
    public function getPermissionsArray(): array
    {
        $permissions = [
            ...
            ['id' => '87', 'name' => 'cash_register_report'],
            ...
            ['id' => '97', 'name' => 'general_settings'],
            ['id' => '98', 'name' => 'payment_settings'],
            ['id' => '99', 'name' => 'invoice _schema'],
            ['id' => '100', 'name' => 'invoice_layout'],
            ['id' => '101', 'name' => 'barcode_settings'],
            ['id' => '102', 'name' => 'cash_counters'],
            ['id' => '103', 'name' => 'view_dashboard_data'],
            ['id' => '104', 'name' => 'accounting_access'],
            ...
            ['id' => '130', 'name' => 'manufacturing_settings'],
            ['id' => '131', 'name' => 'manufacturing_report'],
