...
class ShortMenusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $shortMenus = array(
            ...
            array('id' => '49', 'url' => 'receive.stock.from.warehouse.index', 'name' => 'Receive From Shop/Business', 'icon' => 'fas fa-list', 'permission' => 'transfer_stock_receive_from_branch', 'plan_feature' => 'transfer_stocks', 'enable_module' => 'modules__transfer_stock'),
