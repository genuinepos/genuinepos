...
class ShortMenusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $shortMenus = array(
            ...
            array('id' => '26', 'url' => 'sale.orders.index', 'name' => 'Sales Order List', 'icon' => 'fas fa-list', 'permission' => 'sales_orders_index'),
            array('id' => '29', 'url' => 'sale.quotations.index', 'name' => 'Quotation List', 'icon' => 'fas fa-list', 'permission' => 'sale_quotations_index'),
            array('id' => '30', 'url' => 'sale.drafts.index', 'name' => 'Draft List', 'icon' => 'fas fa-list', 'permission' => 'sale_drafts_index'),
