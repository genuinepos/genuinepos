...
<head>
		...
		<meta charset="utf-8" />
		<title>SpeedDigit POS Pro</title>
		...
		<link href="{{ asset('public') }}/assets/plugins/custom/fullcalendar/fullcalendar.bundle9816.css?v=7.1.3" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="{{ asset('public') }}/assets/plugins/global/plugins.bundle9816.css?v=7.1.3" rel="stylesheet" type="text/css" />
		{{-- <link href="{{ asset('public') }}/assets/plugins/custom/prismjs/prismjs.bundle9816.css?v=7.1.3" rel="stylesheet" type="text/css" /> --}}
		<link href="{{ asset('public') }}/assets/css/style.bundle9816.css" rel="stylesheet" type="text/css" />
		
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		{{-- <link href="{{ asset('public') }}/assets/css/themes/layout/brand/dark9816.css?v=7.1.3" rel="stylesheet" type="text/css"/> --}}
		<link href="{{ asset('public') }}/assets/css/themes/layout/aside/dark9816.css?v=7.1.3" rel="stylesheet" type="text/css"/>
		<link href="{{asset('public')}}/assets/plugins/custom/fileinput/fileinput.min.css" media="all" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
		<link href="{{ asset('public') }}/assets/plugins/custom/data-table/datatable.min.css" rel="stylesheet" type="text/css"/>
		<link href="{{ asset('public') }}/assets/plugins/custom/toastrjs/toastr.min.css" rel="stylesheet" type="text/css"/>
		<link href="{{ asset('public') }}/assets/css/gol.menu.min.css" rel="stylesheet" type="text/css"/>
		<link rel="shortcut icon" href="{{ asset('public') }}/assets/media/logos/favicon.jpg"/>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
									...
									<div class="d-flex flex-column mb-5 align-items-start">
										<div class="d-flex align-items-center">
											<div class="symbol symbol-circle symbol-40 mr-3">
												<img alt="Pic" src="{{ asset('public') }}/assets/media/users/300_12.jpg" />
											</div>
											<div>
    	...
    	<script src="{{ asset('public') }}/assets/plugins/global/plugins.bundle9816.js?v=7.1.3"></script>
		<script src="{{ asset('public') }}/assets/plugins/custom/prismjs/prismjs.bundle9816.js?v=7.1.3"></script>
		<script src="{{ asset('public') }}/assets/js/scripts.bundle9816.js?v=7.1.3"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="{{ asset('public') }}/assets/plugins/custom/fullcalendar/fullcalendar.bundle9816.js?v=7.1.3"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{ asset('public') }}/assets/js/pages/widgets9816.js?v=7.1.3"></script>

		<!--Data table js link-->
		<script src="{{ asset('public') }}/assets/plugins/custom/data-table/datatable.min.js"></script>
		...
		<script>
			...
			$(document).on('click', '#show_sub_menu', function (e) {
				...
				$('.menu_popup_area').addClass('show_popup'); 
				$('.menu_list_area').empty();

				var submenu = $('#'+menu_name).html();
				$('.menu_list_area').html(submenu);

				$('.main_nemu_icon').removeClass('menu_clicked');
				var s = $(this).closest('div').find('.main_nemu_icon').addClass('menu_clicked');
				console.log(s);
				$('.container').hide();
				$('.subheader').hide();
			});

			$('#close_popup_btn').on('click', function (e) {
				e.preventDefault();
				$('.menu_popup_area').removeClass('show_popup');
				$('.main_nemu_icon').removeClass('menu_clicked');
				$('.container').show();
				$('.subheader').show();
