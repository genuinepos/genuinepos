...
$(".calc_wrap").addClass("container-light");
$(".calc_wrap form").addClass("form-light");
$(".calc_wrap form input").addClass("form-input-light");
$(".calc_wrap .operand-group").addClass("operand-group-light");
$(".calc_wrap .operator-group").addClass("operator-group-light");
$(".calc_wrap #equal").addClass("equal-light");
$(".calc_wrap #clear").addClass("clear-light");
$(".calc_wrap #backspace").addClass("backspace-light");
...
// Theme system
$(".calc_wrap input[type='checkbox']").change(function () {
    // dark theme
    if (this.checked) {
        //alert("dark");
