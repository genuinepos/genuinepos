                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row" style="border-right:1px solid black;">
                            <div class="col-md-12">
                                ...
                                <input required name="date" class="form-control" id="contra_date" data-next="contra_credit_account_id" value="{{ date($generalSettings['business__date_format']) }}" placeholder="{{ __("Date") }}" autocomplete="off">
