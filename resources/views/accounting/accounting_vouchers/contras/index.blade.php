...
@section('content')
                            ...
                            <div class="section-header">
                                ...
                                @if(auth()->user()->can('purchase_add'))
                                    <div class="col-2 d-flex justify-content-end">
                                        <a href="{{ route('contras.create') }}" class="btn btn-sm btn-primary" id="addContra"><i class="fas fa-plus-square"></i> {{ __("Add") }}</a>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="modal fade" id="addOrEditContraModal" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true"></div>
...
@push('scripts')
    ...
    <script>
        ...
        var contraTable = $('.data_tbl').DataTable({
            dom: "lBfrtip",
            buttons: [
            ...
            columns: [
                ...
                {data: 'credit_account', name: 'voucherCreditDescription.account.name', className: 'fw-bold'},
                ...
                {data: 'debit_account', name: 'voucherDebitDescription.account.name', className: 'fw-bold'},
        ...
        $(document).on('click', '#addContra', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#addOrEditContraModal').html(data);
                    $('#addOrEditContraModal').modal('show');

                    setTimeout(function() {

                        $('#contra_date').focus().select();
                    }, 500);
                }, error: function(err) {
        ...
        $(document).on('click', '#editContra', function(e) {
            e.preventDefault();
