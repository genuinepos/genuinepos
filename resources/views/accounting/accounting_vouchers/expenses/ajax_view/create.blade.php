                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row" style="border-right:1px solid black;">
                            <div class="col-md-12">
                                ...
                                <input required name="date" class="form-control" id="expense_date" data-next="expense_payment_method_id" value="{{ date($generalSettings['business__date_format']) }}" placeholder="{{ __("Date") }}" autocomplete="off">
