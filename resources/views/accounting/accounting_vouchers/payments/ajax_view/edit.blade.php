                    ...
                    <div class="col-md-4">
                        <div class="row" style="border-right:1px solid black;">
                            <div class="col-md-12">
                                ...
                                <input required name="date" class="form-control" id="payment_date" data-next="payment_payment_method_id" value="{{ date($generalSettings['business__date_format'], strtotime($payment->date)) }}" placeholder="{{ __("Date") }}" autocomplete="off">
