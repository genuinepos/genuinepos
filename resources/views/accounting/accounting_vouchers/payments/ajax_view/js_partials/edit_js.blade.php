    ...
    function calcTotalAmount() {
     ...
     function calculateCurrentBalance() {
        ...
        if (defaultBalanceType == 'dr') {
            ...
            currentBalance = parseFloat(closingBalanceFlatAmount) + parseFloat(payingAmount) - parseFloat(currentPaidAmount);
        }else {
...
@if (!$account)
    <script>
        ...
        function changeAccount (event) {
            ...
            var branchId = "{{ $payment->branch_id == null ? 'NULL' : $payment->branch_id }}";
