                    ...
                    @if ($contra->branch)
                        ...
                        @if ($contra?->branch?->parent_branch_id)
                            ...
                            @if ($contra->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $contra->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($contra->branch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $contra->branch?->logo) }}">
                            @else
