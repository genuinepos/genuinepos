                    ...
                    @if ($expense->branch)
                        ...
                        @if ($expense?->branch?->parent_branch_id)
                            ...
                            @if ($expense->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $expense?->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($expense->branch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $expense?->branch?->logo) }}">
                            @else
