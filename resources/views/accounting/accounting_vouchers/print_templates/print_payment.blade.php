        ...
        <div class="details_area">
                    ...
                    @if ($payment->branch)
                        ...
                        @if ($payment?->branch?->parent_branch_id)
                            ...
                            @if ($payment->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $payment->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($payment->branch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $payment->branch?->logo) }}">
                            @else
            ...
            <div class="row mt-2">
                <div class="col-12 text-center">
                    <h5 class="fw-bold" style="text-transform: uppercase;">{{ __('Payment Voucher') }}</h5>
                </div>
            </div>
...
@else
    ...
    <div class="receipt_voucher_print_template">
        <div class="details_area">
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <p class="fw-bold" style="font-size: 9px">{{ __('Paid To') }} :</p>
                    @foreach ($payment->voucherDescriptions()->where('amount_type', 'dr')->get() as $description)
                        <table class="table print-table table-sm">
                            <thead>
                                <tr>
                ...
                <div class="col-6">
                    <p class="fw-bold" style="font-size: 9px">{{ __('Paid From') }} : </p>
                    @foreach ($payment->voucherDescriptions()->where('amount_type', 'cr')->get() as $description)
                        <table class="table print-table table-sm">
                            <thead>
                                <tr>
