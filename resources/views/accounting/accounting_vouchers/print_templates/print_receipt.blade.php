                    ...
                    @if ($receipt->branch)
                        ...
                        @if ($receipt?->branch?->parent_branch_id)
                            ...
                            @if ($receipt->branch?->parentBranch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $receipt->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($receipt->branch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $receipt->branch?->logo) }}">
                            @else
