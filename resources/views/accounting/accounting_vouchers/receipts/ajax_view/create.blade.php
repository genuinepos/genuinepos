    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="add_receipt_form" action="{{ route('receipts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="print_page_size" id="print_page_size" value="{{ $generalSettings['print_page_size__receipt_voucher_page_size'] }}">
                <div class="form-group row">
                    <div class="col-md-4">
                        <div class="row" style="border-right:1px solid black;">
                            <div class="col-md-12">
                                <label class="fw-bold">{{ __('Date') }} <span class="text-danger">*</span></label>
                                <input required name="date" class="form-control" id="receipt_date" data-next="receipt_payment_method_id" value="{{ date($generalSettings['business_or_shop__date_format']) }}" placeholder="{{ __('Date') }}" autocomplete="off">
                                                    ...
                                                    @if (count($vouchers))
                                                        @foreach ($vouchers as $voucher)
                                                            @php
                                                                ...
                                                                } elseif ($voucher['voucherType'] == App\Enums\DayBookVoucherType::Sales->value) {
