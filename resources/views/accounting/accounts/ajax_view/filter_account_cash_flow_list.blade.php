        ...
        <tr>
            ...
            <td class="text-start">
                ...
                @elseif($cashFlow->transaction_type == 12)  
                    ...
                    <b>{{ $cashFlow->supplier_payment->supplier->name }}</b><br>
                    <b>Voucher No : </b> {{ $cashFlow->supplier_payment->voucher_no }}
                @elseif($cashFlow->transaction_type == 13)  
                    ...
                    <b>{{ $cashFlow->customer_payment->customer->name }}</b><br>
                    <b>Voucher No : </b> {{ $cashFlow->customer_payment->voucher_no }}
                @endif
            </td> 
