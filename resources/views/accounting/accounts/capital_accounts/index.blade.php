...
@push('stylesheets')
@endpush
@section('title', 'Capital Accounts - ')
@section('content')
    <div class="body-woaper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h5>{{ __('Capital Accounts') }}</h5>
                </div>
        ...
        <div class="p-1">
            ...
            <div class="card">
                <div class="section-header">
                    <div class="col-6">
                        <h6>{{ __('List of Capital Accounts') }}</h6>
                    </div>

                    <div class="col-6 d-flex justify-content-end">
                        <a href="{{ route('accounts.create', \App\Enums\AccountCreateAndEditType::Capitals->value) }}" id="addAccountBtn" class="btn btn-sm btn-primary"><i class="fas fa-plus-square"></i> {{ __('Add Accounts') }}</a>
                    </div>
                </div>
...
@endsection
@push('scripts')
    @include('accounting.accounts.capital_accounts.js_partial.index_js')
@endpush
