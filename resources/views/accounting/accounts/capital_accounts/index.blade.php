            ...
            <div class="card">
                <div class="section-header">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <a href="{{ route('accounts.create', \App\Enums\AccountCreateAndEditType::Capitals->value) }}" id="addAccountBtn" class="btn btn-sm btn-success"><i class="fas fa-plus-square"></i> {{ __('Add Accounts') }}</a>
                    </div>
                </div>
