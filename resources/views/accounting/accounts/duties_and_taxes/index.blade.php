            ...
            <div class="card">
                <div class="section-header">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <a href="{{ route('accounts.create', \App\Enums\AccountCreateAndEditType::DutiesAndTaxes->value) }}" id="addAccountBtn" class="btn btn-sm btn-primary"><i class="fas fa-plus-square"></i> {{ __("Add Accounts") }}</a>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        var accounts_table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('accounts.duties.taxes.index') }}",
                "data": function(d) {
