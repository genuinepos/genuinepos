...
@section('content')
    ...
    <div class="modal fade" id="addAssetTypeModal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdrop" aria-hidden="true">
                    ...
                    <form id="add_assset_type_form" action="{{ route('accounting.assets.asset.type.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="asset_type_name" class="form-control" id="asset_type_name" placeholder="@lang('menu.type_name')" />
    ...
    <div class="modal fade" id="editAssetTypeModal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Add Asset Modal -->
    <div class="modal fade" id="addAssetModal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form id="add_assset_form" action="{{ route('accounting.assets.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="asset_name" class="form-control" id="asset_name" placeholder="@lang('menu.asset_type')" autofocus />
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-md-12">
                                ...
                                <input type="number" step="any" name="quantity" class="form-control" id="quantity" placeholder="Asset Quantity" />
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-md-12">
                                ...
                                <input type="number" step="any" name="per_unit_value" class="form-control" id="per_unit_value" placeholder="@lang('menu.per_unit_value')" />
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-md-12">
                                ...
                                <input type="number" step="any" name="total_value" class="form-control" id="total_value" placeholder="Total Asset Value" />
    ...
    <!-- Add Asset Modal -->
    <div class="modal fade" id="editAssetModal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
