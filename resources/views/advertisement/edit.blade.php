            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$data->title}}" name="title" class="form-control" autocomplete="off" placeholder="Advertisement Title">
                    </div>
                </div>
                      ...
                      @foreach($data->attachments as $item)   
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image[]" class="form-control dropify" id="photo" accept="" data-allowed-file-extensions="png jpeg jpg gif avif webp" data-default-file="{{asset('slider/image/'.$item->image)}}">
                            </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div id="urlUploads">
                                <div class="form-group">
                                    <label>{{ __('Url') }}</label>
                                    <input type="text" name="url[]" class="form-control default-url-input" autocomplete="off" placeholder="URL">
                                </div>  
                            </div>
                        </div>
                    </div>
