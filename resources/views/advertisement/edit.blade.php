                     ...
                     <table class="table">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td> <img class="mt-3 mb-3" width="100" height="100" src="{{asset('uploads/advertisement/'.tenant('id').'/file'.'/'.$item->image)}}"></td>
                                 <td> <input type="text" name="default_content_title[]" value="{{$item->content_title}}" class="form-control mt-2" placeholder="Enter Slider Title"></td>
                                 <td> <input type="text" name="default_caption[]" value="{{$item->caption}}" class="form-control mt-2" placeholder="Enter Slider Caption"></td>
                                 <td> <button type="button" class="btn btn-danger btn-sm delete-item" data-id="{{$item->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></td>
                             </tr>
                             @endforeach
                         </tbody>
                     </table>
                             ...
                             <tr>
                                 <td>
                                     <video style="width: 200px;height:150px;" controls autoplay>
                                         <source src="{{asset('uploads/advertisement/'.tenant('id').'/file'.'/'.$data->attachments[0]->video)}}" type="video/mp4">
