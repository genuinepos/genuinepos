                    ...
                    <div class="tab-contents">
                        <form id="add_business_form" action="{{ route('software.service.billing.add.business.confirm') }}" method="post">
                            ...
                            <div class="single-tab active" id="stepOneTab">
                                @include('billing.add_business.partials.cart_partials.step_one')
                            </div>

                            <div class="single-tab" id="stepTwoTab">
                                @include('billing.add_business.partials.cart_partials.step_two')
                            </div>
                        </form>
...
@endsection
@push('js')
    @include('billing.add_business.partials.cart_partials.js_partial.js')
@endpush
