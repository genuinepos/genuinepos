                    ...
                    <div class="tab-contents">
                        <form id="add_shop_form" action="{{ route('software.service.billing.add.shop.confirm') }}" method="POST">
                            ...
                            <div class="single-tab active" id="stepOneTab">
                                @include('billing.add_shop.partials.view_partials.step_one')
                            </div>

                            <div class="single-tab" id="stepTwoTab">
                                @include('billing.add_shop.partials.view_partials.step_two')
                            </div>
                        </form>
...
@endsection
@push('js')
    @include('billing.add_shop.partials.js_partial.js')
@endpush
