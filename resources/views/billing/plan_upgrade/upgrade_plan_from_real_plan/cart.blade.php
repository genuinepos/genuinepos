                    ...
                    <div class="tab-contents">
                        <form id="plan_upgrade_form" action="{{ route('software.service.billing.upgrade.plan.confirm') }}" method="POST">
                            ...
                            <div class="single-tab active" id="stepOneTab">
                                @include('billing.plan_upgrade.upgrade_plan_from_real_plan.partials.cart_partials.step_one')
                            </div>

                            <div class="single-tab" id="stepTwoTab">
                                @include('billing.plan_upgrade.upgrade_plan_from_real_plan.partials.cart_partials.step_two')
                            </div>
                        </form>
...
@endsection
@push('js')
    @include('billing.plan_upgrade.upgrade_plan_from_real_plan.partials.cart_partials.js_partial.js')
@endpush
