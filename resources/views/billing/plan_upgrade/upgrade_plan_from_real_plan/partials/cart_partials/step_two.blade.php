                    ...
                    <div class="row gy-5">
                        <div class="col-12">
                            <div class="calculate-area">
                                <ul>
                                    <li>{{ __('Total Store Quantity') }} <span class="price-txt"><span class="">{{ $currentSubscription->current_shop_count }}</span></span></li>
                                    <li>
                                        {{ __('Net Total') }}
                                        <span class="price-txt">
                                            {{ $planPriceCurrency }} <span class="sub-total">{{ \App\Utils\Converter::format_in_bdt($totalPrice) }}</span>
                                        </span>
                                    </li>
                                    <li>
                                        {{ __('Adjusted Amount') }}
