@extends('billing.layout.master', ['heading' => 'Renew'])
@section('title', 'Renew - ')
                    ...
                    <div class="tab-contents">
                        <form id="shop_renew_form" action="{{ route('software.service.billing.shop.renew.confirm') }}" method="post">
                            ...
                            <div class="single-tab active" id="stepOneTab">
                                @include('billing.shop_renew.partials.cart_partials.step_one')
                            </div>

                            <div class="single-tab" id="stepTwoTab">
                                @include('billing.shop_renew.partials.cart_partials.step_two')
                            </div>
                        </form>
...
@endsection
@push('js')
    @include('billing.shop_renew.partials.cart_partials.js_partial.js')
@endpush
