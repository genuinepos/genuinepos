@if (count($sales))
    @foreach ($sales as $sale)
        <tr>
            ...
            <td class="text-start">{{ $sale->date }}</td>
            ...
            <td class="text-start fw-bold">{{ \App\Utils\Converter::format_in_bdt($sale->total_payable_amount) }}</td>
            <td class="text-start">
    ...
    @endforeach
@else
    <tr><td colspan="5"><b>@lang('menu.no_data_found').</b></td></tr>
@endif
