                   ...
                   <form id="mail_send" enctype="multipart/form-data">
                       ...
                       <div class="row" id="to_area">
                           <div class="col-md-12">
                               ...
                               <div id="emailContainer">
                                   <input type="text" name="subject" class="form-control add_input" placeholder="Subject">
                                   <span class="error error_to"></span>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="row mt-3">
                           ...
                           <div class="col-md-12 d-flex justify-content-end">
                               <div class="loading-btn-box">
                                   <button type="submit" class="btn btn-sm btn-success float-end submit_button btn btn-success product_submit_button p-1">Save</button>
