     ...
     <form id="mail_send" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row" data-select2-id="select2-data-5-qlgx">
                        ...
                        <div class="col-7" data-select2-id="select2-data-4-t4zu">
                            <select name="group_id[]" class="form-control select2 form-select select2-hidden-accessible"
                                multiple="" data-select2-id="select2-data-1-ojy1" tabindex="-1" aria-hidden="true">
                                <option disabled="" data-select2-id="select2-data-10-slgx">Open this select menu
                                </option>

                            </select><span
                                class="select2 select2-container select2-container--default select2-container--below"
                                dir="ltr" data-select2-id="select2-data-2-1b0g" style="width: auto;"><span
                                    class="selection"><span class="select2-selection select2-selection--multiple"
                                        ...
                                        aria-disabled="false">
                                        <ul class="select2-selection__rendered" id="select2-group_id-ia-container"></ul>
                                        <span class="select2-search select2-search--inline">
                                            <textarea class="select2-search__field" type="search" tabindex="0" autocorrect="off" autocapitalize="none"
                                                ...
                                                aria-describedby="select2-group_id-ia-container" placeholder="Select Group" style="width: 100%;"></textarea>
                                        </span>
                    ...
                    <div class="row" id="to_area">
                        <div class="col-md-12">
                            ...
                            <input required="" type="email" name="to[]" class="form-control add_input"
                                data-name="To" id="email" placeholder="Email">
