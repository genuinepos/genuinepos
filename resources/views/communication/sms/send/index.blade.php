                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills flex-column">
                               ...
                               <input type="hidden" id="status_id" value="">
                                ...
                                <li class="nav-item">
                                    <a onclick="getData(0)" href="#" id="v-pills-home-tab" data-bs-toggle="pill"
                                ...
                                <li class="nav-item">
                                    <a onclick="getData(1)" href="#" id="v-pills-profile-tab" data-bs-toggle="pill"
                                ...
                                <li class="nav-item">
                                    <a onclick="getData(2)" href="#" id="v-pills-messages-tab" data-bs-toggle="pill"
                                ...
                                <li class="nav-item">
                                    <a onclick="getData(3)" href="#" id="v-pills-settings-tab" data-bs-toggle="pill"
                                ...
                                <li class="nav-item">
                                    <a onclick="getData(4)" href="#" id="v-pills-settings-tab" data-bs-toggle="pill"
