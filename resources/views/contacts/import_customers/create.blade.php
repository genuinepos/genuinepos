                                    ...
                                    <table class="display table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">{{ __('Opening Balance') }}</td>
                                                <td class="text-start">{{ __('Optional') }}</td>
                                            </tr>

                                            <tr>
                                                <td class="text-start">{{ __('9') }}</td>
                                                <td class="text-start">{{ __('Opening Balance Type') }}</td>
                                                <td class="text-start">{{ __('Optional') }}<br>
                                                    (<small class="text-danger">{{ __('If has opening Balance Then input the type (debit/dr) or (credit/cr) (Must be lower case)') }}.</small>)
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">{{ __('Optional') }}<br>
                                                    (<small class="text-danger">{{ __('If does not have any credit limit so leave this col') }}.</small>)
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">{{ __('Shipping Address') }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    ...
                                                    <br>
                                                    (<small class="text-danger">{{ __('Example: Pay-Term Number : 2, Pay-Term : 2') }} = {{ __('2 Months') }}</small>)
                                                </td>
                                            </tr>
