        ...
        <table class="display table modal-table table-sm">
            <tbody>
                <tr>
                    ...
                    <td class="text-end opening_balance" id="ledger_opening_balance">0</td>
                </tr>

                <tr>
                    <td class="text-end"><strong>{{ __('Total Purchase') }} : {{ $generalSettings['business__currency_symbol'] }}</strong></td>
                    <td class="text-end total_purchase" id="ledger_total_purchase">0</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-end total_sale" id="ledger_total_sale">0</td>
                </tr>

                <tr>
                    <td class="text-end"><strong>{{ __('Total Return') }} : {{ $generalSettings['business__currency_symbol'] }}</strong></td>
                    <td class="text-end total_return" id="ledger_total_return">0</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-end total_received text-danger" id="ledger_total_received">
                        0
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-end closing_balance text-danger" id="ledger_closing_balance">0</td>
                </tr>
            </tbody>
        </table>
    </div>
