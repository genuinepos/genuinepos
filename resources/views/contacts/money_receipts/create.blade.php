...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">{{ __("Generate Money Receipt Voucher") }}</h6>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <strong>{{ __("Shop") }}: </strong> {{ auth()?->user()?->branch ? auth()?->user()?->branch?->name : $generalSettings['business__shop_name'] }}
                </div>
            </div>
            ...
            <form id="add_money_receipt_form" action="{{ route('contacts.money.receipts.store', $contact->id) }}" method="POST">
                ...
                <div class="form-group row mt-2">
                    <div class="col-md-12">
                        ...
                        <input name="note" class="form-control" id="mr_note" data-next="mr_is_customer_name" placeholder="{{ __("Footer Note") }}">
                    </div>
                </div>
                ...
                <div class="extra_label">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="is_header_less" class="form-control" id="mr_is_header_less" data-next="money_receipt_save">
                                <option value="0">{{ __("No") }}</option>
                                <option value="1">{{ __("Yes") }}</option>
                            </select>
                        </div>
