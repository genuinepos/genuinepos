...
<form id="supplier_payment_form" action="{{ route('suppliers.return.payment.add', $supplier->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="number" name="amount" class="form-control form-control-sm p_input" step="any"
                    data-name="Amount" id="p_amount" value="{{ $supplier->total_purchase_return_due }}" />
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="date" name="date" class="form-control form-control-sm date-picker p_input"
                    autocomplete="off" id="p_date" data-name="Date" >
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5">
            ...
            <input readonly type="file" name="attachment" class="form-control form-control-sm" id="attachment"
                data-name="Date">
        </div>
    </div>
