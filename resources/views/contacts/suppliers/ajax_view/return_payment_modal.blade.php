...
<!--begin::Form-->
<form id="supplier_payment_form" action="{{ route('suppliers.return.payment.add', $supplier->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group row">
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="number" name="paying_amount" class="form-control p_input" step="any"
                    data-name="Amount" id="p_paying_amount" value="{{ $supplier->total_purchase_return_due }}" />
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <select name="payment_method_id" class="form-control p_input" id="payment_method_id">
    ...
    <div class="form-group row mt-4">
        <div class="col-md-12">
            ...
            <button name="action" type="button" value="save" class="c-btn button-success float-end" id="add_payment">Save</button>
