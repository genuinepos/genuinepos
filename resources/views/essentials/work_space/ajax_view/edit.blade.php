<form id="edit_work_space_form" action="{{ route('workspace.update', $ws->id) }}" method="post">
    ...
    <div class="form-group row mt-1">
        <div class="col-md-6">
            ...
            <input required type="text" name="start_date" class="form-control datepicker" id="start_date" value="{{ date($generalSettings['business_or_shop__date_format'], strtotime($ws->start_date)) }}">
        </div>

        <div class="col-md-6">
            <label><b>@lang('menu.end_date') </b></label>
            <input required type="text" name="end_date" class="form-control datepicker" id="end_date" value="{{ date($generalSettings['business_or_shop__date_format'], strtotime($ws->end_date)) }}">
        </div>
    </div>
