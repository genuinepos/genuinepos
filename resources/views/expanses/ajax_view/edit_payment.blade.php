        ...
        <div class="col-md-6">
            <div class="payment_top_card">
                <ul class="list-unstyled">
                    ...
                    <li><strong>Branch : </strong>{{ $payment->expense->branch ? $payment->expense->branch->name.''.$payment->expense->branch->branch_code : 'Head Office' }}</li>
                </ul>
            </div>
        </div>
...
<form id="payment_form" action="{{ route('expanses.payment.update', $payment->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-group row">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="date" name="date" class="form-control form-control-sm p_input" autocomplete="off" id="p_date" data-name="Date" value="{{ date("Y-m-d", strtotime($payment->date)) }}">
            </div>
