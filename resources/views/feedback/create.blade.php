...
@push('stylesheets')
<style>
    #body-wraper {padding: 0;}
    .fa-2x{ font-size: 1.6em;}
    .d-none{display: none;}
    .fa-star:hover{color: rgb(57, 230, 51);}
    /* testing work */
    *{ margin: 0; padding: 0; }
    .font-size { font-size: 35px !important;}
    .rate {float: left;height: 46px; padding: 0 10px; }
    .rate:not(:checked) > input {position:absolute; top:-9999px;}
    .rate:not(:checked) > label {float:right; width:1em; overflow:hidden; white-space:nowrap; cursor:pointer; font-size:40px; color:rgb(0, 0, 0); }
