                            ...
                            <div class="breadCrumbHolder module w-100">
                                <div id="breadCrumb3" class="breadCrumb module">
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="{{ route('hrm.dashboard.index') }}" class="text-dark text-muted"><i class="fas fa-tachometer-alt"></i> <b>HRM</b></a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{ route('hrm.departments') }}" class="text-primary"><i class="far fa-building"></i> <b>@lang('menu.department')</b></a>
                                        </li>
