        ...
        <div class="modal-body">
            <form id="add_leave_type_form" action="{{ route('hrm.leave.type.store') }}">
                ...
                <div class="form-group mt-1">
                    ...
                    <input required type="text" name="max_leave_count" class="form-control" id="leave_type_max_leave_count" data-next="leave_type_leave_count_interval" placeholder="{{ __('Max leave count') }}" />
                    <span class="error error_leave_type_max_leave_count"></span>
                </div>

                <div class="form-group mt-1">
                    <label class="fw-bold">{{ __('Leave Count Interval') }}</label>
                    <select name="leave_count_interval" class="form-control" id="leave_type_leave_count_interval" data-next="leave_type_save_btn">
                ...
                <div class="form-group row mt-3">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="btn-loading">
                            ...
                            <button type="submit" id="leave_type_save_btn" class="btn btn-sm btn-success leave_type_submit_button">{{ __("Save") }}</button>
                        </div>
                    </div>
                </div>
            </form>
