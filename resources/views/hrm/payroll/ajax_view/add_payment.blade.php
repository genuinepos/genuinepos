        ...
        <div class="col-md-4">
            <div class="payment_top_card">
                <ul class="list-unstyled">
                    <li><strong>Employee : </strong><span>{{ $payroll->employee->prefix.' '.$payroll->employee->name.' '.$payroll->employee->last_name}}</span> </li>
                </ul>
            </div>
        </div>
        <div class="col-md-4">
                    ...
                    <li>
                        ...
                        <span>
                            @if ($payroll->employee->branch)
                                {{ $payroll->employee->name.'/'.$payroll->employee->branch_code }}
                            @else
