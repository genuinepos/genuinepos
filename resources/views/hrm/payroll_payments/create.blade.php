                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" class="form-control fw-bold text-danger text-end w-25" id="closing_balance_string" value="{{ App\Utils\Converter::format_in_bdt($payroll->gross_amount) }}" placeholder="{{ __("Current Balance") }}">
                                    <input type="hidden" id="closing_balance_flat_amount" value="{{ $payroll->gross_amount }}">
                                </div>
