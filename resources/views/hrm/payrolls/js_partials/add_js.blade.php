<script>
    ...
    $(document).on('click', '#add_more_deduction', function(e) {
        ...
        html += '<td>';
        html += '<input type="number" step="any" name="deduction_amounts[]" class="form-control fw-bold" id="deduction_amount"  value="0.00" placeholder="' + "{{ __('Amount') }}" + '" autocomplete="off">';
        html += '</td>';
    ...
    $('#add_payroll_form').on('submit', function(e) {
        e.preventDefault();
