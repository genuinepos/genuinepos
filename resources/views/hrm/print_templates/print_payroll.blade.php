                    ...
                    @if ($payroll->branch)
                        ...
                        @if ($payroll?->branch?->parent_branch_id)
                            ...
                            @if ($payroll->branch?->parentBranch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ file_link('branchLogo', $payroll->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($payroll->branch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ file_link('branchLogo', $payroll->branch?->logo) }}">
                            @else
                ...
                <div class="col-4">
                    @if ($payroll->branch)
                        ...
                        @if ($payroll?->branch?->parent_branch_id)
                            ...
                            @if ($payroll->branch?->parentBranch?->logo)
                                <img style="height: 45px; width:200px;" src="{{ file_link('branchLogo', $payroll->branch?->parentBranch?->logo) }}">
                            @else
                                <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;text-transform:uppercase;">{{ $payroll->branch?->parentBranch?->name }}</span>
                            @endif
                        @else
                            @if ($payroll->branch?->logo)
                                <img style="height: 45px; width:200px;" src="{{ file_link('branchLogo', $payroll->branch?->logo) }}">
                            @else
                                <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;text-transform:uppercase;">{{ $payroll->branch?->name }}</span>
                            @endif
                        @endif
