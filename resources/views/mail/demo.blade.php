      ...
      <tr>
        ...
        @else
            <td style="width:50%;padding:20px;vertical-align:top">
                ...
                <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">@lang('menu.phone') :</span> {{ json_decode($generalSettings->business, true)['phone'] }}</p>
            </td>
        @endif
      </tr>
      <tr>
