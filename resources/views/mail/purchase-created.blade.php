    ...
    <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px green;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th scope="col" style="font-size:11px;">{{ __('Net Unit Cost') }}({{ $generalSettings['business__currency_symbol'] }})</th>
            ...
            <tr>
                <th colspan="7" style="font-size:11px; text-align:end">@lang('menu.purchase_discount') : {{ $generalSettings['business__currency_symbol'] }}</th>
                <td colspan="2" style="font-size:11px; text-align:end">
            ...
            <tr>
                <th colspan="7" style="font-size:11px; text-align:end">@lang('menu.purchase_tax') : {{ $generalSettings['business__currency_symbol'] }}</th>
                <td colspan="2" style="font-size:11px; text-align:end">
            ...
            <tr>
                <th colspan="7" style="font-size:11px; text-align:end">{{ __('Purchase Total') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                <td colspan="2" style="font-size:11px; text-align:end">
