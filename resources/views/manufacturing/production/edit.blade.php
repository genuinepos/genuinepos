                        ...
                        <div class="element-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="date" class="form-control" id="date" data-next="stock_warehouse_id" value="{{ date($generalSettings['business_or_shop__date_format'], strtotime($production->date)) }}">
