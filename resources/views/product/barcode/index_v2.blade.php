                                                        ...
                                                        <div class="table_area">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table modal-table table-sm">
                                                                    ...
                                                                    <tfoot>
                                                                        <tr>
                                                                            <th colspan="2" class="text-end">{{ __('Total Prepired Qty') }}</th>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <div class="multiple_cmp_btn_area">
                                                        <a href="" class="btn btn-sm btn-danger multiple_completed" style=""> {{ __('Delete Selected All') }} </a> <i data-bs-toggle="tooltip" data-bs-placement="top" title="Note : Delete all items from puchased products which is selected for generation the barcodes" class="fas fa-info-circle tp"></i>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="table-responsive">
                                                <table class="display data_tbl data__table table-hover" id="data">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-start"><input type="checkbox" id="chack_all">{{ __('All') }}</th>
                                                            <th class="text-start">{{ __('Product') }}</th>
                                                            <th class="text-start">{{ __('Supplier') }}</th>
                                                            <th class="text-start">{{ __('Quantity') }}</th>
                                                        </tr>
