                ...
                success:function(supplierProducts){
                    ...
                    $.each(supplierProducts, function (key, sProduct) {
                        ...
                        if (sProduct.product_variant_id != null) {
                            ...
                            var price_inc_tax = parseFloat(sProduct.variant.variant_price) / 100 * parseFloat(tax) + parseFloat(sProduct.variant.variant_price);
                        ...
                        tr += '<input type="hidden" name="supplier_name" id="supplier_name" value="'+sProduct.supplier.prefix+'">';
                        tr += '</td>';
        ...
        $('#generate_barcode_form').on('submit', function(e){
            ...
            productCodes.forEach(function(productCode){
                ...
                var barcode = '';
                    ...
                    var col = codeLength > 11 ? 'col-md-4' : 'col-md-2 px-2';
