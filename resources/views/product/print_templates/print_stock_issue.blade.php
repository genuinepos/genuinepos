                    ...
                    @if ($stockIssue->branch)
                        ...
                        @if ($stockIssue?->branch?->parent_branch_id)
                            ...
                            @if ($stockIssue->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $stockIssue?->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($stockIssue->branch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $stockIssue?->branch?->logo) }}">
                            @else
