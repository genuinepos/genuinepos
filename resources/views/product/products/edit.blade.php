                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <div class="col-10">
                                                <input type="file" name="photo" class="form-control" id="photo" data-allowed-file-extensions="png jpeg jpg gif" data-default-file="{{ $product->thumbnail_photo ? Storage::disk('s3')->url(tenant('id') . '/' . 'product/thumbnail/' . $product->thumbnail_photo) : '' }}">
