                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-6">
                                                    <div class="input-group justify-content-end">
                                                        <a href="#" class="btn btn-sm btn-primary float-end m-0" id="branch_stock_print_report"><i class="fas fa-print "></i> {{ __("Print") }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="display data_tbl data__table b_data_tbl">
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                <th class="text-white text-end" colspan="4">{{ __("Total") }} : </th>
