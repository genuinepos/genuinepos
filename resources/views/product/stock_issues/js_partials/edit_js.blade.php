...
<script>
                    ...
                    if (!$.isEmptyObject(product.product)) {
                        ...
                        if (product.variants.length == 0) {
                            ...
                            $.each(product.variants, function(key, variant) {
                                ...
                                li += '<li>';
                                li += '<a href="#" class="select_variant_product" onclick="selectProduct(this); return false;" data-p_id="' + product.id + '" data-is_manage_stock="' + product.is_manage_stock + '" data-v_id="' + variant.id + '" data-p_name="' + product.name + '" data-v_name="' + variant.variant_name + '" data-is_for_sale="' + product.is_for_sale + '" data-p_cost_inc_tax="' + (variant.update_variant_cost ? variant.update_variant_cost.net_unit_cost : variant.variant_cost_with_tax) + '"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + variant.variant_name + '</a>';
                                li += '</li>';
                            });
                        ...
                        if (product.namedProducts.length > 0) {
                            ...
                            $.each(products, function(key, product) {
                                ...
                                product.thumbnail_photo = product.thumbnail_photo === null ? "{{ asset('images/genaral_default.png') }}" : "{{ asset('uploads/product/thumbnail') }}" + '/' + product.thumbnail_photo;
                                ...
                                if (product.is_variant == 1) {
                                    ...
                                    li += '<li>';
                                    li += '<a href="#" class="select_product" onclick="selectProduct(this); return false;" data-product_type="variant" data-p_id="' + product.id + '" data-v_name="' + product.variant_name + '" data-is_for_sale="' + product.is_for_sale + '" data-is_manage_stock="' + product.is_manage_stock + '" data-v_id="' + product.variant_id + '" data-p_name="' + product.name + '" data-p_code="' + product.variant_code + '" data-p_cost_inc_tax="' + __updateProductCost + '"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + product.variant_name + '</a>';
                                    li += '</li>';
                                } else {

                                    li += '<li>';
                                    li += '<a href="#" class="select_single_product" onclick="selectProduct(this); return false;" data-product_type="single" data-p_id="' + product.id + '" data-v_id="" data-is_manage_stock="' + product.is_manage_stock + '" data-p_name="' + product.name + '" data-v_name="" data-is_for_sale="' + product.is_for_sale + '" data-p_code="' + product.product_code + '" data-p_cost_inc_tax="' + __updateProductCost + '"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + '</a>';
                                    li += '</li>';
                                }
                            });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (uniqueIdValue == undefined) {
                    ...
                    tr += '<input type="hidden" name="stock_issue_product_ids[]">';
                    tr += '</td>';
    ...
    $(document).on('click', '#select_item', function(e) {
        ...
        $('#e_current_quantity').val(parseFloat(current_quantity));
    ...
    //Edit use stock request by ajax
