...
@endpush
@section('title', 'Purchase Returned Products Report - ')
@section('content')
                    ...
                    <div class="main__content">
                        <div class="sec-name">
                            <div class="name-head">
                                ...
                                <h5>{{ __("Purchase Returned Products Report") }}</h5>
                            </div>
                                    ...
                                    <table class="display data_tbl data__table">
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                ...
                                                <th class="text-start text-white">(<span id="return_qty"></span>)</th>
                                                <th class="text-start text-white">---</th>
                                                <th class="text-start text-white">---</th>
                                                <th class="text-start text-white">---</th>
                                                <th class="text-start text-white">---</th>
                                                <th class="text-start text-white" id="return_subtotal"></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
<script>
    var table = $('.data_tbl').DataTable({
        ...
        "ajax": {
            "url": "{{ route('reports.purchase.returned.products.index') }}",
            "data": function(d) {
        ...
        columns: [
            {data: 'date', name: 'purchase_returns.date'},
            {data: 'product', name: 'products.name'},
            {data: 'branch', name: 'branches.name'},
            {data: 'stock_location', name: 'branches.name'},
            {data: 'supplier_name', name: 'suppliers.name'},
            {data: 'voucher_no', name: 'purchase_returns.voucher_no'},
            {data: 'return_qty', name: 'parentBranch.name', className: 'text-end fw-bold'},
            {data: 'unit_cost_exc_tax', name: 'warehouses.warehouse_name', className: 'text-end fw-bold'},
            {data: 'unit_discount_amount', name: 'purchase_return_products.unit_discount_amount', className: 'text-end fw-bold'},
            {data: 'unit_tax_amount', name: 'purchase_return_products.unit_tax_amount', className: 'text-end fw-bold'},
            {data: 'unit_cost_inc_tax', name: 'purchase_return_products.net_unit_cost', className: 'text-end fw-bold'},
            {data: 'return_subtotal', name: 'purchase_return_products.return_subtotal', className: 'text-end fw-bold'},
        ],
    ...
    $(document).on('click', '#print_report', function (e) {
        e.preventDefault();
        var url = "{{ route('reports.purchase.returned.products.print') }}";
