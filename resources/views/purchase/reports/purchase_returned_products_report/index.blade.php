        ...
        var table = $('.data_tbl').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'purchase_return_products.unit_discount_amount',
                    className: 'text-end fw-bold'
                },
                {
                    data: 'unit_tax_amount',
                    name: 'purchase_return_products.unit_tax_amount',
                    className: 'text-end fw-bold'
                },
                {
                    data: 'unit_cost_inc_tax',
                    name: 'purchase_return_products.net_unit_cost',
                    className: 'text-end fw-bold'
                },
                {
                    data: 'return_subtotal',
                    name: 'purchase_return_products.return_subtotal',
                    className: 'text-end fw-bold'
                },
            ],
