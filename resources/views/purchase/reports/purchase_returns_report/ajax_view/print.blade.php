...
<div class="print_area">
    ...
    <div class="row mt-2">
        <div class="col-12 text-center">
            <h6 style="text-transform:uppercase;"><strong>{{ __('Purchase Return Report') }}</strong></h6>
        </div>
    </div>
            ...
            <table class="table report-table table-sm table-bordered print_table">
                <thead>
                    <tr>
                        ...
                        <th class="text-start">{{ __('Parent Purchase') }}</th>
                        ...
                        <th class="text-end">{{ __('Total Returned Amt.') }}</th>
                        <th class="text-end">{{ __('Received Amt.') }}</th>
                ...
                <tbody class="sale_print_product_list">
                    ...
                    @foreach ($returns as $return)
                        ...
                        <tr>
                            ...
                            <td class="text-start">{{ $return->parent_invoice_id }}</td>
                            <td class="text-start">
                                @if ($return->branch_id)
                            ...
                            <td class="text-start">{{ $return->supplier_name }}</td>
                            ...
                            <td class="text-end fw-bold">
                                ...
                                @php
                                    $TotalReceived += $return->received_amount;
                                @endphp
                            </td>
        ...
        <div class="col-6 offset-6">
            <table class="table report-table table-sm table-bordered print_table">
                <thead>
                    ...
                    <tr>
                        <th class="text-end">{{ __('Total Purchase Discount') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                        <td class="text-end">
                    ...
                    <tr>
                        <th class="text-end">{{ __('Total Purchase Tax') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                        <td class="text-end">
                    ...
                    <tr>
                        <th class="text-end">{{ __('Total Purchased Amount') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                        <td class="text-end">
                    ...
                    <tr>
                        <th class="text-end">{{ __('Total Paid') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                        <td class="text-end">
