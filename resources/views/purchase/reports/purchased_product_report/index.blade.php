...
@endpush
@section('title', 'Purchased Products Report - ')
@section('content')
            ...
            <div class="row">
                <div class="border-class">
                    <div class="main__content">
                        <div class="sec-name">
                            <div class="name-head">
                                <h5>{{ __("Purchased Products Report") }}</h5>
                            </div>
...
<script>
    var table = $('.data_tbl').DataTable({
        ...
        "ajax": {
            "url": "{{ route('reports.purchased.products.index') }}",
            "data": function(d) {
        ...
        columns: [
            ...
            {data: 'quantity', name: 'quantity', name: 'parentBranch.name', className: 'text-end fw-bold'},
    ...
    $(document).on('click', '#print_report', function (e) {
        e.preventDefault();
        var url = "{{ route('reports.purchased.products.print') }}";
