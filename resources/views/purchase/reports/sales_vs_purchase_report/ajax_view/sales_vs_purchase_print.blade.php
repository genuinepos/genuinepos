...
<div class="print_area">
    ...
    <div class="row mt-2">
        <div class="col-12 text-center">
            <h6 style="text-transform:uppercase;"><strong>{{ __('Sales Vs Purchase Report') }}</strong></h6>
        </div>
    </div>
                    ...
                    <div class="compare_area mt-3">
                        <p class="text-muted">{{ __("Total Sales Included Return ") }} - {{ __("Total Purchase Included Return") }}:
                            <span>
                                ...
                                {{ App\Utils\Converter::format_in_bdt($salesVsPurchaseAmounts['saleMinusPurchase']) }}
                            </span>
                        </p>
                    </div>
                </div>
