...
<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body" id="add_product_body">
            <form id="add_quick_product_form" action="{{ route('purchases.add.product') }}" method="POST">
                @csrf
                ...
                <div class="form-group row mt-1">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="btn-loading">
                            <button type="button" class="btn loading_button quick_product_loading_button d-hide"><i class="fas fa-spinner"></i><span> @lang('menu.loading')...</span></button>
