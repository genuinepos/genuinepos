<form id="add_supplier_form" action="{{ route('purchases.add.supplier') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="name" class="form-control form-control-sm s_add_input" data-name="Supplier name" id="name" placeholder="Supplier name"/>
    ...
    <div class="form-group row">
        <div class="col-md-3">
            ...
            <input type="text" name="phone" class="form-control form-control-sm s_add_input" data-name="Phone number" id="phone" placeholder="Phone number"/>
