...
<div class="modal-dialog four-col-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Receive Return Amount <span class="type_name"></span></h6>
            ...
            <div class="info_area mb-2">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>Total Return Due : {{ json_decode($generalSettings->business, true)['currency'] }} </strong>{{ $purchase->purchase_return_due }}
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="amount" class="form-control form-control-sm p_input" step="any" data-name="Amount" id="p_amount" value="{{ $purchase->purchase_return_due }}"/>
                        </div>
