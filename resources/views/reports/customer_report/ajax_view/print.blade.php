    ...
    <div class="col-6">
        <table class="table modal-table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <th class="text-end">@lang('menu.total_sale') : {{ $generalSettings['business']['currency'] }}</th>
                ...
                <tr>
                    <th class="text-end">@lang('menu.total_sale_due') : {{ $generalSettings['business']['currency'] }}</th>
                    <td class="text-end">{{ App\Utils\Converter::format_in_bdt($allTotalDue) }}</td>
                </tr>

                <tr>
                    <th class="text-end">{{ __('Total Returnable Due') }} : {{ $generalSettings['business']['currency'] }}</th>
