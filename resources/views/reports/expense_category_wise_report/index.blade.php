                        ...
                        <table class="display data_tbl data__table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">@lang('menu.amount')({{ $generalSettings['business__currency'] }})</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                            <tfoot>
    ...
    <script>
        var table = $('.data_tbl').DataTable({
            ...
            columns: [
                ...
                {data: 'invoice_id', name: 'expanses.invoice_id', className: 'fw-bold'},
                {data: 'from', name: 'branches.name'},
                {data: 'user_name', name: 'users.name'},
                {data: 'amount', name: 'expense_descriptions.amount', className: 'text-end fw-bold'},
        ...
        $(document).on('click', '#print_report', function (e) {
            ...
            $.ajax({
                url:url,
                type:'get',
                data: {branch_id, admin_id, category_id, from_date, to_date},
