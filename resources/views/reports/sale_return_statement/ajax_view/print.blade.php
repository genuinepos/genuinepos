    ...
    <div class="col-6">
        <table class="table modal-table table-sm table-bordered">
            <thead>
                ...
                <tr>
                    <th class="text-end">@lang('menu.total_return_qty') : {{$generalSettings['business__currency']}}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">{{ __('Total Net Return Amount') }} : {{ $generalSettings['business__currency'] }}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">@lang('menu.total') @lang('menu.return_discount') : {{ $generalSettings['business__currency'] }}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">@lang('menu.total_return_amount') : {{ $generalSettings['business__currency'] }}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">{{ __('Total Refunded Amount') }} : {{ $generalSettings['business__currency'] }}</th>
                    <td class="text-end">
