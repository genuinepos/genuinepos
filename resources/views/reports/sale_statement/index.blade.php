                                                ...
                                                <div class="col-md-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label></label>
                                                            <div class="input-group">
                                                                <a href="#" class="btn btn-sm btn-primary float-end" id="print_statement_report"><i class="fas fa-print "></i> Print</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    {{-- <table class="display data_tbl data__table table-hover"> --}}
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                ...
                                                <th id="order_discount_amount" class="text-white text-end"></th>
                                                <th id="order_tax_amount" class="text-white text-end"></th>
                                                <th id="shipment_charge" class="text-white text-end"></th>
...
@push('scripts')
    ...
    <script>
        ...
        var sales_table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('reports.sale.statement.index') }}",
                "data": function(d) {
            ...
            columns: [
                ...
                {data: 'order_tax_amount', name: 'order_tax_amount', className: 'text-end'},
                {data: 'shipment_charge', name: 'shipment_charge', className: 'text-end'},
