...
@push('stylesheets')
    ...
    <style>.log_table td {font-size: 9px;font-weight: 500;}</style>
@endpush
                                    ...
                                    <div class="col-md-12">
                                        <form id="filter_form" class="px-2">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn text-white btn-sm btn-secondary float-end mt-1"><i class="fas fa-funnel-dollar"></i> Filter</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
