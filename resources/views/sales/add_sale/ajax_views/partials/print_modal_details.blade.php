                                ...
                                <tr>
                                    <th class="text-center">
                                        <h6 style="font-size:11px!important;">
                                            @if ($sale?->branch?->parent_branch_id)
                                                <span>{{ $sale?->branch?->parentBranch?->name }}</span>
                                            @else
                                                {{ $sale?->branch?->name }}
                                            @endif
                                        </h6>
                ...
                <div class="amount_area">
                    <table class="w-100">
                        <thead>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Due') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($sale->due) }}
                                    </span>
...
@if ($invoiceLayout->layout_design == 1)
    ...
    <script>
        ...
        document.getElementById('inword').innerHTML = inWords(parseFloat("{{ $sale->total_invoice_amount }}"));
    </script>
@endif
