                                        ...
                                        <div class="row g-1">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input required type="text" name="date" class="form-control" value="{{ date($generalSettings['business_or_shop__date_format'], strtotime($draft->date)) }}" data-next="sale_account_id" autocomplete="off" id="date">
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <select name="sale_tax_ac_id" class="form-control" id="sale_tax_ac_id" data-next="shipment_charge">
                                                    ...
                                                    @foreach ($taxAccounts as $taxAccount)
                                                        <option {{ $draft->sale_tax_ac_id == $taxAccount->id ? 'SELECTED' : '' }} data-order_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                            {{ $taxAccount->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
