                                        ...
                                        <div class="row g-1">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input required type="text" name="date" class="form-control" value="{{ date($generalSettings['business__date_format'], strtotime($draft->date)) }}" data-next="price_group_id" autocomplete="off" id="date">
