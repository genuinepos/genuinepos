...
@section('content')
    ...
    <div class="body-woaper">
        ...
        <div class="p-1">
            <form id="edit_draft_form" action="{{ route('sale.drafts.update', $draft->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                <section>
                                ...
                                <div class="form_element rounded mt-0 mb-1">
                                    <div class="element-body p-1">
                                        <div class="row g-1">
                                                        ...
                                                        <div class="input-group flex-nowrap">
                                                            <select name="customer_account_id" class="form-control select2" id="customer_account_id" data-next="status">
                                                                @foreach ($customerAccounts as $customerAccount)
                                                                    <option {{ $customerAccount->id == $draft->customer_account_id ? 'SELECTED' : '' }} data-pay_term="{{ $customerAccount->pay_term }}" data-pay_term_number="{{ $customerAccount->pay_term_number }}" value="{{ $customerAccount->id }}">{{ $customerAccount->name . '/' . $customerAccount->phone }}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <select name="status" class="form-control" id="status" data-next="date">
                                                            <option value="{{ \App\Enums\SaleStatus::Draft->value }}">{{ \App\Enums\SaleStatus::Draft->name }}</option>

                                                            <option value="{{ App\Enums\SaleStatus::Quotation->value }}">{{ App\Enums\SaleStatus::Quotation->name }}</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    <label class="col-4"><b>{{ __('Draft ID') }}</b></label>
                                                    <div class="col-8">
                                                        <input readonly type="text" class="form-control fw-bold" value="{{ $draft->draft_id }}" autocomplete="off" tabindex="-1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input required type="text" name="date" class="form-control" value="{{ date($generalSettings['business__date_format'], strtotime($draft->date)) }}" data-next="sale_account_id" autocomplete="off" id="date">
                                                    ...
                                                    <div class="col-8">
                                                        <select name="sale_account_id" class="form-control" id="sale_account_id" data-next="price_group_id">
                                                            @foreach ($saleAccounts as $saleAccount)
                                                                <option {{ $saleAccount->id == $draft->sale_account_id ? 'SELECTED' : '' }} value="{{ $saleAccount->id }}">
                                                                    {{ $saleAccount->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="display data__table table sale-product-table">
                                                            ...
                                                            <tbody id="sale_product_list">
                                                                ...
                                                                @foreach ($draft->saleProducts as $saleProduct)
                                                                    @php
                                                                                ...
                                                                                if ($saleProduct?->warehouse) {
                                                                                    ...
                                                                                    if ($draft?->branch) {
                                                                                        if ($draft?->branch?->parentBranch) {
                                                                                            $stockLocationName = $draft?->branch?->parentBranch->name . '(' . $draft?->branch?->area_name;
                                                                                        } else {
                                        ...
                                        <div class="row gx-2 gy-1">
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="shipment_details" class="form-control" id="shipment_details" value="{{ $draft->shipment_details }}" data-next="shipment_address" placeholder="{{ __('Shipment Details') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input name="shipment_address" type="text" class="form-control" id="shipment_address" value="{{ $draft->shipment_address }}" data-next="shipment_status" placeholder="{{ __('Shipment Address') }}">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-8">
                                                        <select name="shipment_status" class="form-control" id="shipment_status" data-next="delivered_to">
                                                            ...
                                                            @foreach (\App\Enums\ShipmentStatus::cases() as $shipmentStatus)
                                                                <option {{ $draft->shipment_status == $shipmentStatus->value ? 'SELECTED' : '' }} value="{{ $shipmentStatus->value }}">{{ $shipmentStatus->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input name="delivered_to" type="text" class="form-control" id="delivered_to" value="{{ $draft->delivered_to }}" data-next="note" placeholder="{{ __('Delivered To') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input name="note" type="text" class="form-control" id="note" value="{{ $draft->note }}" data-next="order_discount" placeholder="{{ __('Note') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form_element rounded m-0">
                                    <div class="element-body">
                                        <div class="row gx-2">
                                            ...
                                            <div class="col-md-7">
                                                <input readonly type="number" step="any" name="total_item" id="total_item" class="form-control fw-bold" value="{{ $draft->total_item }}" tabindex="-1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <input readonly type="number" step="any" name="total_qty" id="total_qty" class="form-control fw-bold" value="{{ $draft->total_qty }}" tabindex="-1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <input readonly type="number" step="any" class="form-control fw-bold" name="net_total_amount" id="net_total_amount" value="{{ $draft->net_total_amount }}" tabindex="-1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" step="any" name="order_discount" class="form-control fw-bold" id="order_discount" data-next="order_discount_type" value="{{ $draft->order_discount }}">
                                                    <input type="number" step="any" name="order_discount_amount" class="d-hide" id="order_discount_amount" value="{{ $draft->order_discount_amount }}" tabindex="-1">

                                                    <select name="order_discount_type" class="form-control" id="order_discount_type" data-next="sale_tax_ac_id">
                                                        <option value="1">{{ __('Fixed') }}(0.00)</option>
                                                        <option {{ $draft->order_discount_type == 2 ? 'SELECTED' : '' }} value="2">{{ __('Percentage') }}(%)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <select name="sale_tax_ac_id" class="form-control" id="sale_tax_ac_id" data-next="shipment_charge">
                                                    ...
                                                    @foreach ($taxAccounts as $taxAccount)
                                                        <option {{ $draft->sale_tax_ac_id == $taxAccount->id ? 'SELECTED' : '' }} {{ $generalSettings['sale__default_tax_id'] == $taxAccount->id ? 'SELECTED' : '' }} data-order_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                            {{ $taxAccount->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <input type="number" step="any" class="d-none" name="order_tax_percent" id="order_tax_percent" value="{{ $draft->order_tax_percent }}">
                                                <input type="number" step="any" class="d-none" name="order_tax_amount" id="order_tax_amount" value="{{ $draft->order_tax_amount }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <input name="shipment_charge" type="number" step="any" class="form-control fw-bold" id="shipment_charge" data-next="save_changes" value="{{ $draft->shipment_charge }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row gx-2 mt-1">
                                            ...
                                            <div class="col-md-7">
                                                <input readonly type="number" step="any" name="total_invoice_amount" id="total_invoice_amount" class="form-control fw-bold" value="{{ $draft->total_invoice_amount }}" tabindex="-1">
                                                <input type="number" step="any" name="sales_ledger_amount" id="sales_ledger_amount" class="d-none" value="0.00" tabindex="-1">
                                            </div>
                                        </div>

                                        <div class="payment_body d-hide">
                                            <div class="row gx-2 mt-1">
                                            ...
                                            <div class="row gx-2 mt-1">
                                                ...
                                                <div class="col-md-7">
                                                    <input readonly type="number" step="any" class="form-control fw-bold text-success" name="previous_received" id="previous_received" value="{{ $draft->paid }}" tabindex="-1">
                                                </div>
                                            </div>
...
@endsection
@push('scripts')
    @include('sales.add_sale.drafts.js_partials.draft_edit_js_script')
@endpush
