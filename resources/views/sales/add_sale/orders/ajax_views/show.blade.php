                    ...
                    <div class="col-md-5">
                         <div class="table-responsive">
                            <table class="display table modal-table table-sm">
                                ...
                                <tr>
                                    <th class="text-end">{{ __("Order Discount") }} : {{ $generalSettings['business__currency'] }} </th>
                                    <td class="text-end">
                                        {{ $order->order_discount_type == 1 ? '(Fixed)=' : '(%)=' }}{{ $order->order_discount }}
                                   </td>
                                </tr>
                                <tr>
                                    <th class="text-end">{{ __("Order Tax") }} : {{ $generalSettings['business__currency'] }}</th>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <th class="text-end">{{ __("Advance Received") }} : {{ $generalSettings['business__currency'] }} </th>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <th class="text-end">{{ __("Due (On Order)") }} : {{ $generalSettings['business__currency'] }}</th>
                                    <td class="text-end">
