...
<div class="print_challan">
    <div class="details_area">
        ...
        @if ($invoiceLayout->is_header_less == 0)
            <div class="row mt-2">
                <div class="col-12 text-center">
                    <h5 style="text-transform: uppercase;"><strong>{{ __('Packing Slip') }}</strong></h5>
                </div>
            </div>
        @endif
        ...
        <div class="row">
            <div class="col-12">
                <p style="font-size:11px!important;"><strong>{{ __('Shipping Address') }} : </strong>{{ $sale->shipment_address }}</p>
                <p style="font-size:11px!important;"><strong>{{ __('Shipping Details') }} : </strong>{{ $sale->shipment_details }}</p>
            </div>
        </div>
