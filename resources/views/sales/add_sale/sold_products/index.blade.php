...
@endpush
@section('title', 'Sold Product List - ')
@section('content')
                                    ...
                                    <div class="element-body">
                                        <form id="filter_form">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <label><strong>{{ __("Sale Screen") }}</strong></label>
                                                    <select name="sale_screen" class="form-control" id="sale_screen" autofocus>
                                                        <option value="">{{ __("All") }}</option>
                                                        @foreach (\App\Enums\SaleScreenType::cases() as $saleScreen)
                                                            <option value="{{ $saleScreen->value }}">{{ $saleScreen->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                ...
                                <div class="table-responsive" id="data-list">
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                ...
                                                <th class="text-white text-end"></th>
                                                <th class="text-white text-end"></th>
                                                <th id="subtotal" class="text-white text-end"></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('sale.products.index') }}",
                "data": function(d) {
                    d.branch_id = $('#branch_id').val();
                    d.customer_account_id = $('#customer_account_id').val();
                    d.sale_screen = $('#sale_screen').val();
            ...
            columns: [
                ...
                {data: 'product', name: 'products.name', className: 'fw-bold'},
                {data: 'invoice_id', name: 'sales.invoice_id', className: 'fw-bold'},
                {data: 'branch', name: 'branches.name'},
                {data: 'stock_location', name: 'warehouses.warehouse_name'},
                {data: 'customer_name', name: 'customers.name'},
                {data: 'sale_screen', name: 'customers.name'},
                {data: 'quantity', name: 'quantity', className: 'text-end fw-bold'},
                {data: 'unit_price_exc_tax', name: 'unit_price_exc_tax', className: 'text-end fw-bold'},
                {data: 'unit_discount_amount', name: 'unit_discount_amount', className: 'text-end fw-bold'},
                {data: 'unit_tax_amount', name: 'unit_tax_amount', className: 'text-end fw-bold'},
                {data: 'unit_price_inc_tax', name: 'unit_price_inc_tax', className: 'text-end fw-bold'},
