...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body" id="payment-modal-body">
                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('menu.customer') : </strong><span>{{ $sale->customer ? $sale->customer->name : 'Walk-In-Customer' }}</span> </li>
            ...
            <form id="payment_form" action="{{ route('sales.payment.add', $sale->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
