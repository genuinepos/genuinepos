        ...
        <div class="col-md-4">
            <div class="payment_top_card">
                <ul class="list-unstyled">
                    <li><strong>Customer : </strong><span>{{ $sale->customer ? $sale->customer->name : 'Walk-In-Customer' }}</span> </li>
                    <li><strong>Business : </strong><span>{{ $sale->customer ? $sale->customer->business_name : '' }}</span> </li>
                </ul>
            </div>
        </div>
        <div class="col-md-4">
            <div class="payment_top_card">
                <ul class="list-unstyled">
                    <li><strong> Invoice ID : </strong><span>{{ $sale->invoice_id }}</span> </li>
                    <li>
...
<form id="sale_payment_form" action="{{ route('sales.payment.add', $sale->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-group row">
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="number" name="amount" class="form-control form-control-sm p_input" step="any" data-name="Amount" id="p_amount" value="{{ $sale->due }}"/>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="text" name="date" class="form-control form-control-sm datepicker p_input" autocomplete="off" id="p_date" data-name="Date" value="{{ date(json_decode($generalSettings->business, true)['date_format']) }}">
            </div>
