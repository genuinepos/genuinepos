                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('menu.customer') : </strong><span>{{ $payment->sale->customer ? $payment->sale->customer->name : 'Walk-In-Customer' }}</span> </li>
                                <li><strong>@lang('menu.business') : </strong><span>{{ $payment->sale->customer ? $payment->sale->customerbusiness_name : '' }}</span> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4">
