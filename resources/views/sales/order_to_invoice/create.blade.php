                                        ...
                                        <div class="row gx-2 gy-1">
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="shipment_details" class="form-control" id="shipment_details" data-next="shipment_address" value="{{ $order?->shipment_details }}" placeholder="{{ __('Shipment Details') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input name="shipment_address" type="text" class="form-control" id="shipment_address" data-next="shipment_status" value="{{ $order?->shipment_address }}" placeholder="{{ __('Shipment Address') }}">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-8">
                                                        <select name="shipment_status" class="form-control" id="shipment_status" data-next="delivered_to">
                                                            ...
                                                            @foreach (\App\Enums\ShipmentStatus::cases() as $shipmentStatus)
                                                                <option @selected($order?->shipment_status == $shipmentStatus->value) value="{{ $shipmentStatus->value }}">{{ $shipmentStatus->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="delivered_to" class="form-control" id="delivered_to" value="{{ $order?->delivered_to }}" data-next="note" placeholder="{{ __('Delivered To') }}">
                                                    </div>
                                                </div>
                                            </div>
