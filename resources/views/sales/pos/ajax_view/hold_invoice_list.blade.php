    ...
    <tbody>
        @foreach ($holdInvoices as $holdInvoice)
            <tr>
                ...
                <td class="text-start">
                    <a id="editInvoice" href="{{ route('sales.pos.edit', $holdInvoice->id) }}"><i class="far fa-edit text-dark text-muted mr-1"></i></a>
                    <a id="delete" href="{{ route('sales.delete', $holdInvoice->id) }}"><i class="far fa-trash-alt text-danger mr-1"></i></a>
                </td>
            </tr>  
        @endforeach
    </tbody>
