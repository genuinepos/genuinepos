        ...
        <div class="details_area">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    @if ($sale->branch->pos_sale_invoice_layout->account_name || $sale->branch->pos_sale_invoice_layout->account_no || $sale->branch->pos_sale_invoice_layout->bank_name || $sale->branch->pos_sale_invoice_layout->bank_branch)
                ...
                <div class="col-md-6">
                    <table class="table modal-table table-sm">
                        <tbody>
                            <tr>
                                <td class="text-endx"><strong>@lang('menu.net_total_amount') : {{ $generalSettings['business_or_shop__currency_symbol'] }} </strong></td>
                                <td class="text-endx">
                ...
                <div class="customer_info mt-2">
                    <table class="w-100">
                        <thead>
                            <tr>
                                <th class="text-center">
                                    <b>@lang('menu.date')</b> <span>{{ date($generalSettings['business_or_shop__date_format'], strtotime($sale->date)) . ' ' . date($timeFormat, strtotime($sale->time)) }}</span>
                                </th>
                            </tr>
