@foreach ($quotations as $quotation)
    <tr>
        ...
        <td class="text-start">
            <a id="editInvoice" href="{{ route('sales.pos.edit', $quotation->id) }}" title="Edit" class=""><i class="far fa-edit text-info me-1"></i></a>
            <a id="delete" href="{{ route('sales.delete', $quotation->id) }}" title="Delete" class=""><i class="far fa-trash-alt text-danger me-1"></i></a>
