...
@foreach ($products as $product)
    @php
        ...
        $productImage = $product->thumbnail_photo ? file_link(fileType: 'productThumbnail', fileName: $product->thumbnail_photo) : asset('images/general_default.png');

        $variantImage = $product->variant_image ? file_link(fileType: 'productVariant', fileName: $product->variant_image) : $productImage;
