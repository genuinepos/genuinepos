        ...
        <div class="row">
            <div class="col-6">
                <div class="row align-items-center">
                    <div class="col-sm-4">
                        <label for="inputEmail3" class="col-form-label text-white">@lang('menu.total_qty') :</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-6">
                <div class="row align-items-center">
                    <div class="col-sm-4">
                        <label for="inputEmail3" class="col-form-label text-white">@lang('menu.total_item'):</label>
                    </div>
                    <div class="col-sm-8 ">
