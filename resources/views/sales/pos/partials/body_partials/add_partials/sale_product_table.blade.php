        ...
        <div class="form-field-area px-2 py-1">
            ...
            <div class="row align-items-end mt-1">
                <div class="col-md-4">
                    ...
                    <input type="text" name="serial_no" class="form-control" id="serial_no" value="{{ isset($jobCard) ? $jobCard->serial_no : '' }}" placeholder="{{ isset($generalSettings['service_settings__serial_number_label']) ? $generalSettings['service_settings__serial_number_label'] : __('Serial No') }}" autocomplete="off">
                </div>
