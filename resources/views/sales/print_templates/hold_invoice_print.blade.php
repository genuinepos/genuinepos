                    ...
                    @if ($holdInvoice->branch)
                        ...
                        @if ($holdInvoice?->branch?->parent_branch_id)
                            ...
                            @if ($holdInvoice->branch?->parentBranch?->logo && $invoiceLayout->show_shop_logo == 1)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $holdInvoice->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($holdInvoice->branch?->logo && $invoiceLayout->show_shop_logo == 1)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $holdInvoice->branch?->logo) }}">
                            @else
