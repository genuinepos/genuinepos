                        ...
                        @if ($quotation->branch)
                            ...
                            @if ($quotation?->branch?->parent_branch_id)
                                ...
                                @if ($quotation->branch?->parentBranch?->logo && $invoiceLayout->show_shop_logo == 1)
                                    <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $quotation->branch?->parentBranch?->logo) }}">
                                @else
                            ...
                            @else
                                @if ($quotation->branch?->logo && $invoiceLayout->show_shop_logo == 1)
                                    <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $quotation->branch?->logo) }}">
                                @else
                ...
                <div class="col-6">
                    <table class="table modal-table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <td class="text-end fw-bold" style="font-size:11px!important;">{{ __('Total Amount') }} : {{ $generalSettings['business_or_shop__currency_symbol'] }}</td>
                                <td class="text-end" style="font-size:11px!important;">
                    ...
                    <div class="col-4">
                        @if ($quotation->branch)
                            ...
                            @if ($quotation?->branch?->parent_branch_id)
                                ...
                                @if ($quotation->branch?->parentBranch?->logo && $invoiceLayout->show_shop_logo == 1)
                                    <img style="height: 40px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $quotation->branch?->parentBranch?->logo) }}">
                                @else
                                    <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;">{{ $quotation->branch?->parentBranch?->name }}</span>
                                @endif
                            @else
                                @if ($quotation->branch?->logo && $invoiceLayout->show_shop_logo == 1)
                                    <img style="height: 40px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $quotation->branch?->logo) }}">
                                @else
                                    <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;">{{ $quotation->branch?->name }}</span>
                                @endif
                            @endif
                ...
                <div class="col-6">
                    <table class="table modal-table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <td class="text-end fw-bold" style="font-size:9px!important; height:10px; line-height:10px;">{{ __('Total Amount') }} : {{ $generalSettings['business_or_shop__currency_symbol'] }}</td>
                                <td class="text-end" style="font-size:11px!important;height:10px; line-height:10px;">
                                    {{ App\Utils\Converter::format_in_bdt($quotation->total_invoice_amount) }}
                                </td>
                            </tr>
