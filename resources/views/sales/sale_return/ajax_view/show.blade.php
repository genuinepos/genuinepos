                    ...
                    <div class="col-md-6 offset-md-6">
                        <div class="table-responsive">
                            <table class="table modal-table tabl-sm">
                                <tr>
                                    <th class="text-start">@lang('menu.net_total_amount') : {{ $generalSettings['business__currency'] }} </th>
                                ...
                                <tr>
                                    <th class="text-start">@lang('menu.return_discount') : {{ $generalSettings['business__currency'] }} </th>
                                ...
                                <tr>
                                    <th class="text-start">@lang('menu.total_return_amount') : {{ $generalSettings['business__currency'] }} </th>
                                ...
                                <tr>
                                    <th class="text-start">@lang('menu.total_paid')/@lang('menu.refunded_amount') : {{ $generalSettings['business__currency'] }} </th>
                                    <td class="text-start total_return_amount">
