                            ...
                            <div class="row gx-2">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <div class="col-8">
                                            <input type="text" name="date" class="form-control add_input" data-name="Date" value="{{ date($generalSettings['business']['date_format'], strtotime($return->date)) }}" autocomplete="off" id="date">
