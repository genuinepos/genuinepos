                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>@lang('menu.date'): {{ date($generalSettings['business__date_format'] ,strtotime($sale->date)) . ' ' .date($timeFormat ,strtotime($sale->time)) }}</strong></li>
                ...
                <div class="col-md-6">
                    <table class="table modal-table table-sm">
                        <tbody>
                            <tr>
                                <td class="text-end">
                                    <strong>@lang('menu.net_total_amount') : {{ $generalSettings['business__currency'] }}</strong>
                                </td>
                ...
                <div class="amount_area">
                    <table class="w-100">
                        <thead>
                            ...
                            <tr>
                                <th class="text-start"><strong> @lang('menu.change_amount') : {{ $generalSettings['business__currency'] }}</strong></th>
                            ...
                            <tr>
                                <th class="text-end"> Due : {{ $generalSettings['business__currency'] }}</th>
                                <th class="text-end">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($total_due > 0 ? $total_due : 0) }}
                                    </span>
