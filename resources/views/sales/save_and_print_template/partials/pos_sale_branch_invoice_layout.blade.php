                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            @if (json_decode($generalSettings->reward_point_settings, true)['enable_cus_point'] == 1)
                                <li>
                                    <strong>{{ json_decode($generalSettings->reward_point_settings, true)['point_display_name'] }} : </strong> {{ $sale->customer ? $sale->customer->point : 0 }}
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="amount_area">
                    <table class="w-100">
                        <thead>
                            ...
                            <tr>
                                <th class="text-end"> <strong>@lang('menu.due') : {{ json_decode($generalSettings->business, true)['currency'] }}</strong></th>
                                <th class="text-end">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($total_due) }}
                                    </span>
