                            ...
                            <div class="heading text-end">
                                ...
                                @else
                                    ...
                                    @if ($defaultLayout->branch_email && $generalSettings['business']['email'])
                                        <p><strong>@lang('menu.email') :</strong> {{ $generalSettings['business']['email'] }}</p>
                                    @endif
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            @if ($generalSettings['reward_point_settings']['enable_cus_point'] == 1)
                                <li><strong>{{ $generalSettings['reward_point_settings']['point_display_name'] }} : </strong>
                                    ...
                                    @if ($defaultLayout->show_shop_logo == 1)
                                        ...
                                        @else
                                            @if ($generalSettings['business']['business_logo'] != null)
                                                <img style="height: 40px; width:200px;" src="{{ asset('uploads/business_logo/' . $generalSettings['business']['business_logo']) }}" alt="logo" class="logo__img">
                                            @else
                                                <span style="font-family: 'Anton', sans-serif; font-size:15px;color:black; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">{{ $generalSettings['business']['shop_name'] }}</span>
                                            @endif
                                        @endif
                                    @endif
                                </th>
                ...
                <div class="amount_area">
                    <table class="w-100">
                        <thead>
                            ...
                            <tr>
                                <th class="text-end">@lang('menu.total_payable') : {{ $generalSettings['business']['currency'] }}</th>
                                <th class="text-end">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($total_payable_amount) }}
                                    </span>
