...
@if ($invoiceLayout->layout_design == 1)
    ...
    <div class="sale_print_template">
        ...
        <div class="details_area">
                ...
                <div class="col-6">
                    <table class="table print-table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <td class="text-end" style="font-size:11px!important;"><strong>{{ __('Total Invoice Amount') }} : {{ $generalSettings['business__currency_symbol'] }} </strong></td>
                                <td class="text-end" style="font-size:11px!important;">
                            ...
                            <tr>
                                <td class="text-end" style="font-size:11px!important;"><strong>{{ __('Received Amount') }} : {{ $generalSettings['business__currency_symbol'] }} </strong></td>
                            ...
                            <tr>
                                <td class="text-end" style="font-size:11px!important;"><strong>{{ __('Due (On Invoice)') }} : {{ $generalSettings['business__currency_symbol'] }}</strong></td>
                                <td class="text-end" style="font-size:11px!important;">
                            ...
                            <tr>
                                <td class="text-end" style="font-size:11px!important;"><strong>{{ __('Current Balance') }} : {{ $generalSettings['business__currency_symbol'] }}</strong></td>
                                <td class="text-end" style="font-size:11px!important;">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p style="font-size: 10px!important;">{!! $invoiceLayout->invoice_notice ? '<strong>' . __('Attention') . ' : </strong>' . $invoiceLayout->invoice_notice : '' !!}</p>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <table class="w-100">
                        <thead class="t-head">
                            <tr>
                                ...
                                <th class="text-center" style="font-size:10px;">{{ __('Qty') }}</th>
                                <th class="text-center" style="font-size:10px;">{{ __('Price') }}</th>
                                <th class="text-end" style="font-size:10px;">{{ __('Total') }}</th>
                            </tr>
                        </thead>
                        <thead class="d-body">
                            @foreach ($customerCopySaleProducts as $saleProduct)
                                <tr>
                                    ...
                                    @endphp
                                    <th style="width: 50%;" class="text-start" style="font-size:10px;">{{ $loop->index + 1 }}. {{ Str::limit($saleProduct->p_name, 25, '') . $variant }}</th>
                                    <th class="text-center" style="font-size:10px;">{{ (float) $saleProduct->quantity }}</th>
                                    <th class="text-center" style="font-size:10px;">{{ App\Utils\Converter::format_in_bdt($saleProduct->unit_price_inc_tax) }}</th>
                                    <th class="text-end" style="font-size:10px;">{{ App\Utils\Converter::format_in_bdt($saleProduct->subtotal) }}</th>
                                </tr>
                            @endforeach
                        </thead>
                    </table>
                ...
                <div class="amount_area">
                    <table class="w-100">
                        <thead>
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Net Total') }} : {{ $generalSettings['business__currency_symbol'] }} </th>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Sale Discount') }} : {{ $generalSettings['business__currency_symbol'] }} </th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($sale->order_discount_amount) }}
                                    </span>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Sale Tax') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Total Invoice Amt.') }} : {{ $generalSettings['business__currency_symbol'] }} </th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($sale->total_invoice_amount) }}
                                    </span>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Received Amount') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($__receivedAmount > 0 ? $__receivedAmount : $sale->paid) }}
                                    </span>
                            ...
                            @if ($changeAmount > 0 && $__receivedAmount > 0)
                                <tr>
                                    <th class="text-end" style="font-size:11px;">{{ __('Change') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                    <th class="text-end" style="font-size:11px;">
                                        <span>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Due (On Invoice)') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ App\Utils\Converter::format_in_bdt($sale->due) }}
                                    </span>
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px;">{{ __('Current Balance') }} : {{ $generalSettings['business__currency_symbol'] }}</th>
                                <th class="text-end" style="font-size:11px;">
                                    <span>
                                        {{ $amounts['closing_balance_in_flat_amount_string'] }}
                                    </span>
