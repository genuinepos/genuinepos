                ...
                @if ($jobCard->branch)
                    @if ($jobCard?->branch?->parent_branch_id)
                        ...
                        @if ($jobCard->branch?->parentBranch?->logo)
                            <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $jobCard->branch?->parentBranch?->logo) }}">
                        @else
                    ...
                    @else
                        @if ($jobCard->branch?->logo)
                            <img style="height: 40px; width:100px;" src="{{ Storage::disk('s3')->url(tenant('id') . '/' . 'branch_logo/' . $jobCard->branch?->logo) }}">
                        @else
