...
@endpush
@section('title', 'Service Quotation List - ')
@section('content')
                            ...
                            <div class="section-header">
                                ...
                                @if (auth()->user()->can('create_add_sale'))
                                    <div class="col-6 d-flex justify-content-end">
                                        <a href="{{ route('services.quotations.create') }}" class="btn btn-sm btn-primary" id="add_btn"><i class="fas fa-plus-square"></i> {{ __('Add') }}</a>
                                    </div>
                                @endif
                            </div>
...
@push('scripts')
    @include('services.quotations.js_partials.index_js')
@endpush
