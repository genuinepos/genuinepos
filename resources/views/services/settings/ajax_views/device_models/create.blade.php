<div class="modal-dialog col-40-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="add_device_model_form" action="{{ route('services.settings.device.models.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group row mt-2">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="btn-loading">
                            ...
                            <button type="submit" id="device_model_save" class="btn btn-sm btn-success device_model_submit_button">{{ __('Save') }}</button>
                        </div>
                    </div>
                </div>
            </form>
...
@include('services.settings.ajax_views.device_models.js_partials.create_js')
