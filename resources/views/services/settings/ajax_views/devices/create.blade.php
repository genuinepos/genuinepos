<div class="modal-dialog col-40-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">{{ __('Add Device') }}</h6>
            ...
            <form id="add_device_form" action="{{ route('services.settings.devices.store') }}" method="POST">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <input required type="text" name="name" class="form-control" id="device_name" data-next="device_short_description" placeholder="{{ __('Device Name') }}" />
