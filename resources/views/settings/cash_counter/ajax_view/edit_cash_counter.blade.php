<form id="edit_cash_counter_form" action="{{ route('settings.cash.counter.update', $cc->id) }}" method="POST"
    ...
    <div class="form-group row">
        <div class="col-md-12">
            ...
            <input type="text" name="counter_name" class="form-control" id="e_counter_name"
                placeholder="Cash Counter name" value="{{ $cc->counter_name }}"/>
    ...
    <div class="form-group row mt-2">
        <div class="col-md-12">
            ...
            <input type="text" name="short_name" class="form-control" id="e_short_name" placeholder="Short Name" value="{{ $cc->short_name }}"/>
