                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="price-txt">$<span class="main-price">100</span></span></td>
                                                <td class="text-danger">31-12-2023</td>
                                                <td>
                                                    <div class="product-count cart-product-count">
                                                        <div class="quantity rapper-quantity">
                                                            <input type="number" min="5" max="100" step="1" value="1" readonly>
                                                ...
                                                <td><span class="price-txt">$<span class="total-price">100</span></span></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>SpeedDigit Computers (Motijheel)</td>
                                                <td><span class="price-txt">$<span class="main-price">100</span></span></td>
                                                <td class="text-danger">31-12-2023</td>
                                                <td>
                                                    <div class="product-count cart-product-count">
                                        ...
                                        <div class="col-12">
                                            <div class="calculate-area">
                                                <ul>
                                                    ...
                                                    <li>Net Total <span class="price-txt">$<span class="sub-total">500</span></span></li>
                                                    ...
                                                    <li class="total-price-wrap">Total <span class="price-txt">$<span id="totalPrice">500</span></span></li>
                                                </ul>
