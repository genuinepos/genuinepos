@extends('setups.billing.layout.master', ['heading' => 'Renew'])
@section('title', 'Renew - ')
@section('heading', 'Renew')
@push('css')
@endpush
@section('content')
    @php
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="tab-contents">
                        <form id="shop_renew_form" action="{{ route('software.service.billing.shop.renew.confirm') }}" method="post">
                            @csrf
                            ...
                            <div class="single-tab active" id="stepOneTab">
                                @include('setups.billing.shop_renew.partials.cart_partials.step_one')
                            </div>

                            <div class="single-tab" id="stepTwoTab">
                                @include('setups.billing.shop_renew.partials.cart_partials.step_two')
                            </div>
                        </form>
...
@endsection
@push('js')
    @include('setups.billing.shop_renew.partials.cart_partials.js_partial.js')
@endpush
