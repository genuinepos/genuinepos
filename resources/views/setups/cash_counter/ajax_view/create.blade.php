            ...
            <form id="add_cash_counter_form" action="{{ route('cash.counters.store') }}" method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input required type="text" name="name" class="form-control" id="cash_counter_name" data-next="short_name" placeholder="{{ __("Counter Name") }}"/>
                        <span class="error error_cash_counter_name"></span>
                    </div>
                </div>
