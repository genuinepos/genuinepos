    ...
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <div class="input-group">
                <input type="number" name="view_stock_expiry_alert_for" class="form-control" id="view_stock_expiry_alert_for"  value="{{ $generalSettings['dashboard__view_stock_expiry_alert_for'] }}" autocomplete="off">
    ...
    <div class="row mt-2">
        <div class="col-md-12 d-flex justify-content-end">
            <div class="btn-loading">
                <button type="button" class="btn loading_button dashboar_settings_loading_btn d-hide"><i class="fas fa-spinner"></i><span> {{ __('Loading') }}...</span></button>
