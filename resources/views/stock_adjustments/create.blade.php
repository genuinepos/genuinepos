                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <div class="col-7">
                                            <input type="text" name="date" class="form-control" id="date" value="{{ date($generalSettings['business__date_format']) }}" data-next="type" autocomplete="off">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group mt-1">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="col-8">
                                                                <input readonly type="number" class="form-control fw-bold" step="any" step="any"
                                                                    name="net_total_amount" id="net_total_amount" value="0.00" tabindex="-1">
                                                            </div>
                                                        </div>
                                                    </div>
