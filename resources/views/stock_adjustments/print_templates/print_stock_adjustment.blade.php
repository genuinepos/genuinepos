                    ...
                    @if ($adjustment->branch)
                        ...
                        @if ($adjustment?->branch?->parent_branch_id)
                            ...
                            @if ($adjustment->branch?->parentBranch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $adjustment->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($adjustment->branch?->logo)
                                <img style="height: 60px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $adjustment->branch?->logo) }}">
                            @else
                ...
                <div class="col-4">
                    @if ($adjustment->branch)
                        ...
                        @if ($adjustment?->branch?->parent_branch_id)
                            ...
                            @if ($adjustment->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $adjustment->branch?->parentBranch?->logo) }}">
                            @else
                                <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;">{{ $adjustment->branch?->parentBranch?->name }}</span>
                            @endif
                        @else
                            @if ($adjustment->branch?->logo)
                                <img style="height: 40px; width:200px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $adjustment->branch?->logo) }}">
                            @else
                                <span style="font-family: 'Anton', sans-serif;font-size:15px;color:gray;">{{ $adjustment->branch?->name }}</span>
                            @endif
                        @endif
