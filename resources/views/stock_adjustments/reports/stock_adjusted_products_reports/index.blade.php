...
<script>
    var table = $('.data_tbl').DataTable({
        ...
        columns: [
            ...
            {data: 'voucher_no', name: 'stock_adjustments.voucher_no'},
            {data: 'quantity', name: 'product_variants.variant_name', className: 'text-end fw-bold'},
            {data: 'unit_cost_inc_tax', name: 'products.product_code', className: 'text-end fw-bold'},
            {data: 'subtotal', name: 'product_variants.variant_code', className: 'text-end fw-bold'},
    ...
    $(document).on('click', '#print_report', function (e) {
        ...
        $.ajax({
            url:url,
            type:'get',
            data: {branch_id, branch_name, type, from_date, to_date},
