    ...
    <div class="modal-dialog modal-full-display">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>{{ __('B.Location Name') }} :</strong>
                                {{ $transfer->sender_branch? $transfer->sender_branch->name . '/' . $transfer->sender_branch->branch_code: $generalSettings['business']['shop_name'] . '(HO)' }}
                            </li>
                            <li><strong>@lang('menu.phone') : </strong>
                                {{ $transfer->sender_branch? $transfer->sender_branch->phone: $generalSettings['business']['phone'] }}
                            </li>
                            ...
                            <li><strong>@lang('menu.stock_location') : </strong>
                                ...
                                @else
                                    {{ $transfer->sender_branch? $transfer->sender_branch->name . '/' . $transfer->sender_branch->branch_code . '(B.L)': $generalSettings['business']['shop_name'] . '(HO)' }}
                                @endif
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>{{ __('B.Location Name') }} :</strong>
                                {{ $transfer->receiver_branch? $transfer->receiver_branch->name . '/' . $transfer->receiver_branch->branch_code: $generalSettings['business']['shop_name'] . '(HO)' }}
                            </li>
                            <li><strong>@lang('menu.phone') : </strong>
                                {{ $transfer->receiver_branch? $transfer->receiver_branch->phone: $generalSettings['business']['phone'] }}
                            </li>
                    ...
                    <div class="col-md-6 offset-6">
                        <div class="table-responsive">
                            <table class="table modal-table table-sm">
                                ...
                                <tr>
                                    <th class="text-end">@lang('menu.transfer_cost') :</th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="footer_btn btn btn-sm btn-primary print_btn">@lang('menu.print_details')</button>
        ...
        <div class="sale_and_deal_info pt-3">
            <div class="row">
                <div class="col-lg-4">
                    <ul class="list-unstyled">
                        <li><strong>@lang('menu.from') : </strong></li>
                        <li><strong>{{ __('B.Location Name') }} :</strong> {{ $transfer->sender_branch ? $transfer->sender_branch->name.'/'.$transfer->sender_branch->branch_code : $generalSettings['business']['shop_name'].'(HO)' }}</li>
                        <li><strong>@lang('menu.phone') : </strong> {{ $transfer->sender_branch ? $transfer->sender_branch->phone : $generalSettings['business']['phone'] }}</li>
                ...
                <div class="col-lg-4">
                    <ul class="list-unstyled">
                        <li><strong>@lang('menu.to') : </strong></li>
                        <li><strong>{{ __('B.Location Name') }} :</strong> {{ $transfer->receiver_branch ? $transfer->receiver_branch->name.'/'.$transfer->receiver_branch->branch_code : $generalSettings['business']['shop_name'].'(HO)' }}</li>
                        <li><strong>@lang('menu.phone') : </strong> {{ $transfer->receiver_branch ? $transfer->receiver_branch->phone : $generalSettings['business']['phone'] }}</li>
    ...
    <div class="details_area">
        <div class="heading_area">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-12">
                    <div class="heading text-center">
                        <h6 class="bill_name">@lang('menu.transfer_challan')</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <thead>
                    <tr>
                        <tr>
                            <th class="text-start">@lang('menu.sl')</th>
                            <th class="text-start">@lang('menu.product')</th>
                            <th class="text-start">@lang('menu.send_qty')</th>
