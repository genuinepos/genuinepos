                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <label for="inputEmail3" class="col-4"><b>B.Location :</b><span class="text-danger">*</span></label>
                                        <div class="col-8">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <label for="inputEmail3" class=" col-4"><b>Ref ID :</b> </label>
                                        <div class="col-8">
...
@push('scripts')
    ...
    <script>
        ...
        function searchProduct(product_code, branch_id){
            $.ajax({
                url:"{{ url('transfer/stocks/to/warehouse/search/product') }}"+"/"+product_code+"/"+branch_id,
                dataType: 'json',
