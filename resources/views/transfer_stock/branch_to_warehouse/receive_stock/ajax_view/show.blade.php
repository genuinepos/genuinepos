                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="heading text-center">
                            ...
                            <small class="company_address">{{ $generalSettings['business']['address'] }}</small><br>
                            <small class="company_address">@lang('menu.phone') : {{ $generalSettings['business']['phone'] }}</small>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            @else
                            <li>
                                <strong>@lang('menu.address') : </strong> {{ $generalSettings['business']['address'] }}
                            </li>
                            @endif
                        </ul>
                    </div>
