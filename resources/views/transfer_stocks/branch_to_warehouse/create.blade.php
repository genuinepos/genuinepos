...
@endpush
@section('title', 'Add Transfer Stock (Shop/Business To Warehouse)')
@section('content')
    <div class="body-woaper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    ...
                    <h6>{{ __("Add Tranfer Stock (Shop/Business To Warehouse)") }}</h6>
                </div>
        ...
        <div class="p-1">
            <form id="add_transfer_branch_to_warehouse_form" action="{{ route('transfer.stock.branch.to.warehouse.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form_element rounded mt-0 mb-1">
                        <div class="element-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <label class="col-5"><b>{{ __("Receiver Warehouse") }}</b> <span class="text-danger">*</span></label>
                                        <div class="col-7">
                                            <select name="receiver_warehouse_id" class="form-control" id="receiver_warehouse_id" data-next="date" autofocus>
                                                <option value="">{{ __("Select Receiver Warehouse") }}</option>
    ...
    <script>
        ...
        $('#add_item').on('click', function(e) {
            ...
            if (e_variant_id != 'noid') {
                ...
                var url = "{{ route('general.product.search.variant.product.stock', [':e_product_id', ':e_variant_id']) }}";
                route = url.replace(':e_product_id', e_product_id);
                route = route.replace(':e_variant_id', e_variant_id);
            } else {

                var url = "{{ route('general.product.search.single.product.stock', [':e_product_id']) }}";
                route = url.replace(':e_product_id', e_product_id);
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if ($.isEmptyObject(data.errorMsg)) {
                        ...
                        var stockLocationMessage = " {{ __('in the Shop/Business') }}";
        ...
        $('#add_transfer_branch_to_warehouse_form').on('submit', function(e){
            e.preventDefault();
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(!$.isEmptyObject(data.successMsg)){
                        ...
                        $('#add_transfer_branch_to_warehouse_form')[0].reset();
