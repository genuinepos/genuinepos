...
@endpush
@section('title', 'Transfer Stocks (Shop/Business To Warehouse) - ')
@section('content')
                    ...
                    <div class="p-1">
                        ...
                        <div class="card">
                            <div class="section-header">
                                <div class="col-6">
                                    <h6>{{ __('List Of Transfer Stocks (Shop/Business To Warehouse)') }}</h6>
                                </div>

                                <div class="col-6 d-flex justify-content-end">
                                    <a href="{{ route('transfer.stock.branch.to.warehouse.create') }}" class="btn btn-sm btn-primary" id="add_btn"><i class="fas fa-plus-square"></i> {{ __("Add") }}</a>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('transfer.stock.branch.to.warehouse.index', \App\Enums\TransferStockType::BranchToWarehouse->value) }}",
                "data": function(d) {
