                    ...
                    @if ($transferStock->branch)
                        ...
                        @if ($transferStock?->branch?->parent_branch_id)
                            ...
                            @if ($transferStock->branch?->parentBranch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $transferStock->branch?->parentBranch?->logo) }}">
                            @else
                        ...
                        @else
                            @if ($transferStock->branch?->logo)
                                <img style="height: 40px; width:100px;" src="{{ asset('uploads/' . tenant('id') . '/' . 'branch_logo/' . $transferStock->branch?->logo) }}">
                            @else
