...
@endpush
@section('title', 'Receive From Warehouse - ')
@section('content')
                    ...
                    <div class="main__content">
                        <div class="sec-name">
                            <div class="name-head">
                                ...
                                <h5>{{ __("Receive From Warehouse") }}</h5>
                            </div>
                                    ...
                                    <div class="element-body">
                                        <form id="filter_form">
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                    <label><strong>{{ __("Receiver Warehouse") }}</strong> <span class="text-danger">*</span></label>

                                                    <select class="form-control" id="warehouse_id" autofocus>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('receive.stock.from.warehouse.index') }}",
                "data": function(d) {
