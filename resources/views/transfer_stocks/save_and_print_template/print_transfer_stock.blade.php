    ...
    <div class="details_area">
        ...
        <div class="row mt-2">
            <div class="col-12 text-center">
                <h6 style="text-transform: uppercase;" class="fw-bold">{{ __('Transfer Stock Voucher') }}</h6>
                {{-- <p class="fw-bold">{{ __("Own Shop/Business To Another Shop/Business") }}</p> --}}
            </div>
        </div>
            ...
            <div class="col-4">
                <ul class="list-unstyled">
                    <li style="font-size:11px!important;"><strong>{{ __('Date') }} : </strong>
                        <b>{{ date($generalSettings['business_or_shop__date_format'], strtotime($transferStock->date)) }}</b>
                    </li>
