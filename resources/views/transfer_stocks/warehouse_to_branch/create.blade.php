...
@endpush
@section('title', 'Add Transfer Stock (Warehouse To Show/Business)')
@section('content')
    <div class="body-woaper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    ...
                    <h6>{{ __("Add Tranfer Stock (Warehouse To Shop/Business)") }}</h6>
                </div>
        ...
        <div class="p-1">
            <form id="add_transfer_warehouse_to_branch_form" action="{{ route('transfer.stock.warehouse.to.branch.store') }}" method="POST">
                @csrf
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <div class="col-8">
                                            <input type="text" name="voucher_no" id="voucher_no" class="form-control" placeholder="Voucher No" autocomplete="off">
                                        </div>
                                    </div>
                                </div> --}}
                            </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group">
                                                ...
                                                class="form-control fw-bold" id="total_qty" tabindex="-1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if ($.isEmptyObject(data.errorMsg)) {
                        ...
                        var stockLocationMessage = sender_warehouse_id ? ' in selected warehouse' : ' in the Shop/Business';
        ...
        $('#add_transfer_warehouse_to_branch_form').on('submit', function(e){
            e.preventDefault();
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(!$.isEmptyObject(data.successMsg)){
                        ...
                        window.location = "{{ route('transfer.stock.warehouse.to.branch.index') }}";
                    }else{

                        $('#add_transfer_warehouse_to_branch_form')[0].reset();
