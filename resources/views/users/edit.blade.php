                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="first_name" class="form-control"
                                                            placeholder="First Name" id="first_name" value="{{ $user->name }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="email" id="email" class="form-control"
                                                            placeholder="exmple@email.com" value="{{ $user->email }}">
                                        ...
                                        <div class="auth_field_area">
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <label class="col-4"> <span
                                                                class="text-danger">*</span> <b>Role :</b> <i data-bs-toggle="tooltip" data-bs-placement="top" title="Admin has access to all business location." class="fas fa-info-circle tp"></i></label>
                                                        <div class="col-8">
                                                            <select name="role_id" id="role_id" class="form-control">
                                                                <option {{ $user->role_type == 2 ? 'SELECTED' : '' }} value="">Admin</option>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="phone" class="form-control" autocomplete="off" placeholder="Phone number" value="{{ $user->phone }}">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="bank_ac_no" class="form-control" placeholder="Account number" autocomplete="off" value="{{ $user->bank_ac_no }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="bank_name" class="form-control" placeholder="Bank name" autocomplete="off" value="{{ $user->bank_name }}">
                                                    </div>
                                                </div>
                                            </div>
