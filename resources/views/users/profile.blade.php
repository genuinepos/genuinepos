                                ...
                                <div class="form_element m-0 mt-2">
                                    ...
                                    <div class="element-body">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-9">
                                                        <input type="text" name="prefix" class="form-control"
                                                            placeholder="Mr / Mrs / Miss" value="{{ auth()->user()->prefix }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="email" id="email" class="form-control"
                                                            placeholder="exmple@email.com" value="{{ auth()->user()->email }}">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label for="inputEmail3" class="col-4"><b>Default Language :</b> </label>
                                                    <div class="col-8">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <select name="marital_status" class="form-control">
                                                            ...
                                                            <option {{ auth()->user()->marital_status == 'Married' ? 'SELECTED' : '' }}
                                                                value="Married">Married</option>
                                                            <option {{ auth()->user()->marital_status == 'Unmarried' ? 'SELECTED' : '' }}
                                                                value="Unmarried">Unmarried</option>
                                                            <option {{ auth()->user()->marital_status == 'Divorced' ? 'SELECTED' : '' }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="bank_ac_no" class="form-control" placeholder="Account number" autocomplete="off" value="{{ auth()->user()->bank_ac_no }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="bank_name" class="form-control" placeholder="Bank name" autocomplete="off" value="{{ auth()->user()->bank_name }}">
                                                    </div>
                                                </div>
                                            </div>
