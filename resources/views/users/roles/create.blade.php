                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="user_activities_log_index" id="user_activities_log_index" class="users user_activities_log">
                                                        <label for="user_activities_log_index">{{ __('View User Activities Log') }}</label>
                                                    </p>

                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="user_activities_log_only_own_log" id="user_activities_log_only_own_log" class="users user_activities_log">
                                        ...
                                        <div class="element-body border-top">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="selling_price_group_edit" id="selling_price_group_edit" class="products selling_price_group_edit">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sale_quotations_index" id="sale_quotations_index" class="sales sale_quotations">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sale_quotations_delete" id="sale_quotations_delete" class="sales sale_quotations">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sale_drafts_index" id="sale_drafts_index" class="sales sale_drafts">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sale_drafts_delete" id="sale_drafts_delete" class="sales sale_drafts">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sales_orders_index" id="sales_orders_index" class="sales sales_orders">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="sales_orders_delete" id="sales_orders_delete" class="sales sales_orders">
                                        ...
                                        <div class="element-body border-top">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="vat_tax_report" id="vat_tax_report" class="accounting account_reports">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <p class="text-info checkbox_input_wrap">
                                                        <label>
                                                            <input type="checkbox" class="service_quotations" id="select_all" data-target="service_quotations" autocomplete="off">
                                                            <strong>{{ __('Quotations') }}</strong>
                                                        </label>
                                                    </p>

                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="service_quotations_index" id="service_quotations_index" class="service_quotations services">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        ...
                                                        <label for="service_quotations_create">{{ __('Quotation Add') }}</label>
                                                    </p>

                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="service_quotations_edit" id="service_quotations_edit" class="service_quotations services">
                                                        <label for="service_quotations_edit">{{ __('Quotation Edit') }}</label>
                                                    </p>
...
@endsection
@push('scripts')
    @include('users.roles.js_partials.create_js')
@endpush
