                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" name="supplier_report" id="supplier_report" class="contacts contact_all">
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" name="customer_report" id="customer_report" class="contacts customer_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" name="barcode_settings" id="barcode_settings" class="setup setup_all">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="assign_todo" id="assign_todo" class="manage_tasks manage_task_all">
                                                        <label for="assign_todo"> {{ __('Todo') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="work_space" id="work_space" class="manage_tasks manage_task_all">
                                                        <label for="work_space"> {{ __('Work Spaces') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="memo" id="memo" class="manage_tasks manage_task_all">
                                                        <label for="memo">{{ __('Memo') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" name="msg" id="msg" class="manage_tasks manage_task_all">
