                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('supplier_report') ? 'CHECKED' : '' }} name="supplier_report" id="supplier_report" class="contacts contact_all">
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('customer_report') ? 'CHECKED' : '' }} name="customer_report" id="customer_report" class="contacts customer_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('product_settings') ? 'CHECKED' : '' }} name="product_settings" id="product_settings" class="products product_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('purchase_settings') ? 'CHECKED' : '' }} name="purchase_settings" id="purchase_settings" class="purchase purchase_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('view_expense') ? 'CHECKED' : '' }} name="view_expense" id="view_expense" class="expenses expenses_all">
                                                    <label for="view_expense">{{ __('View Expense') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('add_expense') ? 'CHECKED' : '' }} name="add_expense" id="add_expense" class="expenses expenses_all">
                                                    <label for="add_expense">{{ __('Add Expense') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('edit_expense') ? 'CHECKED' : '' }} name="edit_expense" id="edit_expense" class="expenses expenses_all">
                                                    <label for="edit_expense">{{ __('Edit expense') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('delete_expense') ? 'CHECKED' : '' }} name="delete_expense" id="delete_expense" class="expenses expenses_all">
                                                    <label for="delete_expense"> {{ __('Delete Expense') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('expense_category') ? 'CHECKED' : '' }} name="expense_category" id="expense_category" class="expenses expenses_all">
                                                    <label for="expense_category">{{ __('Expense Category') }} &rarr; {{ __('View/Add/Edit/Delete') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('category_wise_expense') ? 'CHECKED' : '' }} name="category_wise_expense" id="category_wise_expense" class="expenses expenses_all">
                                                    <label for="category_wise_expense">{{ __('View Category Wise Expense') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('expanse_report') ? 'CHECKED' : '' }} name="expanse_report" id="expanse_report" class="expenses expenses_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('add_sale_settings') ? 'CHECKED' : '' }} name="add_sale_settings" id="add_sale_settings" class="sales sale_all">
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('pos_sale_settings') ? 'CHECKED' : '' }} name="pos_sale_settings" id="pos_sale_settings" class="sales pos_sale_all">
                                ...
                                <div id="setup_permission" class="collapse" data-bs-parent="#setup_permission" style="">
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                <p class="text-info checkbox_input_wrap">
                                                    <label> <input type="checkbox" class="setup" id="select_all" data-target="setup_all" autocomplete="off">
                                                        <strong>{{ __('Set-up') }}</strong>
                                                    </label>

                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('tax') ? 'CHECKED' : '' }} name="tax" id="tax" class="setup setup_all">
                                                    <label for="tax">{{ __('Tax') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('branch') ? 'CHECKED' : '' }} name="branch" id="branch" class="setup setup_all">
                                                    <label for="branch"> {{ __('Business Location') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('warehouse') ? 'CHECKED' : '' }} name="warehouse" id="warehouse" class="setup setup_all">
                                                    <label for="warehouse">{{ __('Warehouse') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('general_settings') ? 'CHECKED' : '' }} name="general_settings" id="general_settings" class="setup setup_all">
                                                    <label for="general_settings">{{ __('General Settings') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('payment_settings') ? 'CHECKED' : '' }} name="payment_settings" id="payment_settings" class="setup setup_all">
                                                    <label for="payment_settings">{{ __('Payment Settings') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('invoice_schema') ? 'CHECKED' : '' }} name="invoice_schema" id="invoice_schema" class="setup setup_all">
                                                    <label for="invoice_schema">{{ __('Invoice Schema') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('invoice_layout') ? 'CHECKED' : '' }} name="invoice_layout" id="invoice_layout" class="setup setup_all">
                                                    <label for="invoice_layout"> {{ __('Invoice Layout') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('barcode_settings') ? 'CHECKED' : '' }} name="barcode_settings" id="barcode_settings" class="setup setup_all">
                                                    <label for="barcode_settings">{{ __('Barcode Sticker Settings') }}</label>
                                                </p>
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('cash_counters') ? 'CHECKED' : '' }} name="cash_counters" id="cash_counters" class="setup setup_all">
                                    ...
                                    <div class="element-body border-top">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <p class="checkbox_input_wrap mt-1">
                                                    <input type="checkbox" {{ $role->hasPermissionTo('accounting_access') ? 'CHECKED' : '' }} name="accounting_access" id="accounting_access" class="accounting accounting_all">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('hrm_dashboard') ? 'CHECKED' : '' }} name="hrm_dashboard" id="hrm_dashboard" class="hrms hrm_all">
                                                        <label for="hrm_dashboard">{{ __('HRM Dashboard') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('attendance') ? 'CHECKED' : '' }} name="attendance" id="attendance" class="hrms hrm_all">
                                                        <label for="attendance">{{ __('Attendance') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('payroll') ? 'CHECKED' : '' }} name="payroll" id="payroll" class="hrms hrm_all">
                                                        <label for="payroll"> {{ __('Payroll') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('payroll_report') ? 'CHECKED' : '' }} name="payroll_report" id="payroll_report" class="hrms hrm_all">
                                                        <label for="payroll_report">{{ __('Payroll Report') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('payroll_payment_report') ? 'CHECKED' : '' }} name="payroll_payment_report" id="payroll_payment_report" class="hrms hrm_all">
                                                        <label for="payroll_payment_report">{{ __('Payroll Payment Report') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('attendance_report') ? 'CHECKED' : '' }} name="attendance_report" id="attendance_report" class="hrms hrm_all">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('leave_type') ? 'CHECKED' : '' }} name="leave_type" id="leave_type" class="hrms hrm_others_all">
                                                        <label for="leave_type"> {{ __('Leave Type') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('leave_assign') ? 'CHECKED' : '' }} name="leave_assign" id="leave_assign" class="hrms hrm_others_all">
                                                        <label for="leave_assign">{{ __('Leave Assign') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('shift') ? 'CHECKED' : '' }} name="shift" id="shift" class="hrms hrm_others_all">
                                                        <label for="shift">{{ __('Shift') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('view_allowance_and_deduction') ? 'CHECKED' : '' }} name="view_allowance_and_deduction" id="view_allowance_and_deduction" class="hrms hrm_others_all">
                                                        <label for="view_allowance_and_deduction">{{ __('Allowance and deduction') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('holiday') ? 'CHECKED' : '' }} name="holiday" id="holiday" class="hrms hrm_others_all">
                                                        <label for="holiday"> {{ __('Holidays') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('department') ? 'CHECKED' : '' }} name="department" id="department" class="hrms hrm_others_all">
                                                        <label for="department"> {{ __('Departments') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('designation') ? 'CHECKED' : '' }} name="designation" id="designation" class="hrms hrm_others_all">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('assign_todo') ? 'CHECKED' : '' }} name="assign_todo" id="assign_todo" class="manage_tasks manage_task_all">
                                                        <label for="assign_todo"> {{ __('Todo') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('work_space') ? 'CHECKED' : '' }} name="work_space" id="work_space" class="manage_tasks manage_task_all">
                                                        <label for="work_space">{{ __('Work Spaces') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('memo') ? 'CHECKED' : '' }} name="memo" id="memo" class="manage_tasks manage_task_all">
                                                        <label for="memo"> {{ __('Memo') }}</label>
                                                    </p>
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('msg') ? 'CHECKED' : '' }} name="msg" id="msg" class="manage_tasks manage_task_all">
                                        ...
                                        <div class="element-body border-top">
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    ...
                                                    <p class="checkbox_input_wrap mt-1">
                                                        <input type="checkbox" {{ $role->hasPermissionTo('manufacturing_settings') ? 'CHECKED' : '' }} name="manufacturing_settings" id="manufacturing_settings" class="manufacturings manufacturing_all">
