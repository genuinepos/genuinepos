...
Route::controller(GeneralProductSearchController::class)->prefix('general/product/search')->group(function () {
    ...
    Route::get('check/product/discount/with/single/or/variant/branch/stock/{productId}/{variantId?}/{priceGroupId?}', 'checkProductDiscountWithSingleOrVariantBranchStock')->name('general.product.search.check.product.discount.with.single.or.variant.branch.stock');
